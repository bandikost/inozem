...
export default function ThirdBlock() {
    ...
    return (
        <section className="border border-dotted border-zinc-300 py-4 rounded hover:shadow-2xl">
            ...
            <ul className="grid grid-cols-3 gap-4 px-6 mt-8 pb-8">
                <li className="text-blue text-3xl">17 лет <p className="text-default text-sm">Предоставляем качество</p></li>
                <li className="text-prpl text-3xl">10 минут<p className="text-default text-sm">Предоставляем качество</p></li>
                <li className="text-blue text-3xl">Более 15400<p className="text-default text-sm">Предоставляем качество</p></li>
            </ul>
        </section>
    )
}
    ...
    {({ isSubmitting }) => (
      <div className="flex flex-col md:flex-row w-full max-w-4xl">
        <div className="flex-1 p-8  md:rounded-lg shadow-md
          ...
          <p className="mt-8">Академия медицинского образования им. Ф.И.Иноземцева</p>
        </div>
        ...
        <Form className="bg-white -ml-8 p-8 md:rounded-lg shadow-md grid grid-cols-1 w-full md:w-lg" style={{ boxShadow: '-15px 0px 15px -5px rgba(0,0,0,0.4)' }}>
            ...
            <div className="flex items-center gap-2 mt-4">
              <Field className="font-medium !bg-blue-700" type="checkbox" name="teacher" />
              <span className="text-zinc-700 text-sm md:text-lg">Являетесь ли вы преподавателем?</span>
            </div>

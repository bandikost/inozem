...
const filteredByYear = dates.filter((row) => {
    ...
    <div className="max-w-4xl mx-auto my-10">
      ...
      {!loading && selected && dates.length === 0 && (
        <p className="text-zinc-700 flex !font-semibold text-lg">
         ...
         <span className="underline px-2 text-green">{selected}</span>  еще не получила итоги.
        </p>
      )}

      {!loading && filteredByYear.length > 0 && (
        <div>

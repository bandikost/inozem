...
export default function AccredTable({ specialties }: { specialties: string[] }) {
  ...
  return (
    <div className="max-w-4xl mx-auto my-10">
      ...
      {!loading && selected && dates.length === 0 && (
        <p className="text-zinc-700 flex font-semibold">
         <Hourglass className="animate-wait mr-2" /> Ближайшие даты ожидаются
        </p>
      )}

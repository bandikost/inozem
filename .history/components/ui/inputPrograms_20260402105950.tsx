...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <div className="border border-zinc-200 rounded-xl p-3 tablet:p-6 bg-white shadow-xl transition">
        ...
        <div className="flex flex-col computer:flex-row justify-between gap-4 items-start mt-2">
            ...
            <div className="flex flex-col items-start tablet:items-end gap-3 mt-10 tablet:mt-0">

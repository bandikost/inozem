...
export default function QuestionButton() {
    ...
    return (
        <section className="fixed right-3 bottom-5 z-100">
            ...
            {openMenu && (
                <div className=" bg-white border border-gray-300 rounded-md w-[300px] h-[350px] shadow-2xl relative">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <hr className="border border-gray-300 w-full" />
                        <Link className="button-more mt-4" href={"/bid"}>Подать заявку на обучение</Link>
                    </div>
                </div>
            )}

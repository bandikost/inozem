...
export default function QuestionButton() {
    ...
    return (
        <section className="fixed right-0 bottom-0 z-10">
            
            <div
                className={`bg-white border border-gray-300 rounded-md h-[340px] shadow-2xl relative transform transition-all duration-300 ease-in-out
                    ${openMenu ? "opacity-100 scale-100" : "opacity-0 scale-75 pointer-events-none"}
                `}>
                {openMenu && (
                    <>
                        <button 
                        ...
                        <div className="flex flex-col items-center -mr-10 w-[280px]">

        ...
        <section className="fixed right-3 bottom-5 z-100">
            ...
            {openMenu && (
                <div className="bg-white border border-gray-300 rounded-md w-[320px] h-[400px] shadow-2xl relative">
                    ...
                    <p className="py-3 px-4">Добрый день! Часто задаваемые вопросы находятся <Link className="hover:underline" href={"/contacts"} onClick={() => handleOpenMenu()}>в разделе</Link></p>
                    <p className="mt-10 py-3 px-4">Вы можете заполнить заявку на интересующую вас программу и наши сотрудники ответят вам в ближайшее время!</p>
                </div>
            )}

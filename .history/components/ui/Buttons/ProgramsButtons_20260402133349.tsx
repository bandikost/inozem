    ...
    <div className="fixed left-10 top-1/3 -translate-y-1/3 z-50 bg-white border border-gray-300 shadow-2xl rounded-md">
      <ul className='flex flex-col text-xl'>
        <li>
          <button
            className={`p-4 cursor-pointer w-full text-left flex items-center gap-1 ${
              activeId === 1 ? 'bg-prpl text-white' : '!text-[#212127] hover:bg-prpl hover:!text-white'
            }`}
        ...
        <li>
          <button
            className={`p-4 cursor-pointer w-full text-left flex items-center gap-1 ${
              activeId === 2 ? 'bg-prpl text-white' : '!text-[#212127] hover:bg-prpl hover:!text-white'
            }`}
        ...
        <li>
          <button
            className={`p-4 cursor-pointer w-full text-left flex items-center gap-1 ${
              activeId === 3 ? 'bg-prpl text-white' : '!text-[#212127] hover:bg-prpl hover:!text-white'
            }`}

    ...
    <>
      ...
      {menuOpen && (
        <div className="!fixed inset-0 z-50 2xl:hidden">
          ...
          <div className="fixed left-0 top-0 !translate-y-2/3 h-full w-72 bg-white shadow-xl p-4 animate-slideIn">
            ...
            <div className="flex flex-col border border-gray-300 rounded-md text-sm">

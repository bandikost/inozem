  ...
  return createPortal(
    <>
      <button
        ...
        className="fixed left-4 top-4 z-50 flex items-center gap-2 bg-prpl text-white px-4 py-2 rounded-md shadow-lg md:hidden"
      >
        <Menu size={18} />
        Меню
      </button>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="fixed left-0 !top-1/4 !translate-y-1/4 h-full w-72 bg-white shadow-xl p-4 animate-slideIn">
      ...
      <div className="hidden md:block fixed left-7 top-1/3 -translate-y-1/3 z-50 bg-white border border-gray-300 shadow-2xl rounded-md">

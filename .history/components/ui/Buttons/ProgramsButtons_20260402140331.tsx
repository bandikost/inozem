  ...
  return createPortal(
    <>
      <button
        ...
        className="fixed left-0 top-1/3 z-50 flex items-center gap-2 bg-prpl text-white px-4 py-2 rounded-md shadow-lg computer:hidden"
      >
        <Menu size={18} />
        Меню
      </button>
      ...
      {menuOpen && (
        <div className="!fixed inset-0 z-50 computer:hidden">
      ...
      <div className="hidden computer:block fixed left-7 top-1/3 -translate-y-2/3 z-50 bg-white border border-gray-300 shadow-2xl rounded-md">

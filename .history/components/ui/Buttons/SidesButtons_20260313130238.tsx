...
export default function SidesButtons() {
  ...
  return null
    ...
    return (
        <div className="flex flex-col sm:flex-row justify-between mt-8 mb-12">
        ...
        <div className="flex flex-col mr-4 gap-2">
          {learning.map(item => (
            <button
              ...
              className={`px-2 py-2 button-more w-full ${activeId === item.id ? "button-active" : ""}`}>
              {item.title}
            </button>
          ))}
        </div> 

            <div className="w-full border border-gray-300 rounded shadow-xl bg-white px-6 py-3 mt-8 sm:mt-0">

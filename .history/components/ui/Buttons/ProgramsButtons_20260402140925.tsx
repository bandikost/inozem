  ...
  return createPortal(
    <>
      <button
        ...
        className="fixed left-0 top-1/3 z-50 flex items-center gap-2 bg-prpl text-white px-4 py-2 rounded-md shadow-lg 2xl:hidden"
      >
        <Menu size={18} />
        Меню
      </button>
      ...
      {menuOpen && (
        <div className="!fixed inset-0 z-50 2xl:hidden">
          ...
          <div className="fixed left-0 top-0 !translate-y-2/3 h-full w-72 bg-white shadow-xl p-4 animate-slideIn rounded-md">
            ...
            <div className="flex flex-col border border-gray-300 rounded-md text-base">
              <li className='!text-[#212127] hover:bg-prpl hover:!text-white list-none'><ButtonItem id={1} icon={Files} text="Форма, Анкеты, Заявления" /></li>
      ...
      <div className="hidden 2xl:block fixed left-0 top-1/3 -translate-y-2/3 z-50 bg-white border border-gray-300 shadow-2xl rounded-md rounded-right">

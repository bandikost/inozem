...
export default function LogoutButton() {
  ...
  return (
    <>
      <button onClick={handleLogout} className="cursor-pointer bg-red-500 flex p-8 justify-center text-2xl rounded-md items-center gap-1 hover:opacity-70 shadow-2xl">

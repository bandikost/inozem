...
import { Circle, CircleX, FileQuestion } from "lucide-react"
...
export default function QuestionButton() {
    ...
    return (
        <section className="fixed -right-0.5 -bottom-1 z-10">
            ...
            {!openMenu && (
                <button 
                    className="button-more shadow transform transition-all duration-300 hover:scale-105 !text-lg flex gap-4" 
                    onClick={handleOpenMenu}
                >
                  <FileQuestion />  Задать вопрос 
                </button>
            )}
        </section>
    )

...
export default function QuestionButton() {
    ...
    return (
        <section className="fixed -right-0.5 -bottom-1 z-10">
                ...
                {openMenu && (
                    <>
                        ...
                        <div className="flex flex-col items-center  h-[280px] w-[280px]">
                            ...
                            <p className="mt-1 py-3 px-4 !text-base">
                                Если вы не нашли ответ на нужный вопрос, можете заполнить заявку, и наши сотрудники ответят вам в ближайшее время!
                            </p>
                            <hr className="border border-gray-300 w-full" />
                            <Link 
            ...
            {!openMenu && (
                <button 
                    className="button-more shadow transform transition-all duration-300 hover:scale-105 !text-lg" 
                    onClick={handleOpenMenu}
                >
                    Задать вопрос
                </button>

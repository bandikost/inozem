...
export default function QuestionButton() {
    ...
    >
        <button
            ...
            className="absolute top-3 right-3 rounded-full p-1 text-gray-500 hover:bg-gray-100 transition text-red-400"
        >
            <CircleX size={22}  className="text-white"/>
        </button>

        <div className="bg-prpl text-white px-5 py-4">
            <div className="flex items-center gap-2">
                <Circle size={10} fill="limegreen" stroke="limegreen"  />

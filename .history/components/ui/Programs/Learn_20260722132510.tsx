  ...
  return (
    <div className="flex flex-col items-center mb-12">
      <div className="w-full max-w-5xl">
        ...
        <div className="hover:opacity-70 cursor-pointer flex items-center overflow-hidden rounded-2xl border border-gray-300 bg-white transition-all duration-300 mt-4 p-5 text-lg justify-between">

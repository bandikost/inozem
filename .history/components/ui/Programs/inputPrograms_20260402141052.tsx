    ...
    <div className="mt-10 border border-zinc-200 rounded-xl p-3 tablet:p-6 bg-white shadow-xl transition ">
        ...
        <div className="flex flex-col computer:flex-row justify-between gap-4 items-center mt-2">
            <div className="flex flex-col items-start gap-3 -ml-7 computer:ml-0">
                ...
                <input value={inputValue} onChange={(e) => setInputValue(e.target.value) } className="border border-gray-300 rounded p-2 w-[240px] xs:w-[300px] !text-default" placeholder="Введите название..." />
            </div>

          ...
          <div className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-2 mt-8">
              ...
              <div className="rounded-xl bg-zinc-50 p-4">
                ...
                <button className="text-md text-center !font-normal cursor-pointer border border-gray-200 p-1 rounded-xl hover:bg-white" onClick={() => toggleDates(program.id)}> {dates.length - 2 < 0 ? "" : `и еще ${dates.length - 2} ${filtredName} ${openedDates === program.id ? "Скрыть" : "Показать"}` }</button>

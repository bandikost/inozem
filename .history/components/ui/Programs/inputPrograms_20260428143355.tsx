...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <section className="flex flex-col items-center">
       ...
       <div className="flex flx-col tablet:flex-row items-start mt-10 mb-20 w-full gap-6">
        ...
        <div className="flex flex-col items-center ">
            ...
            <button onClick={handleReset} className="button-more mt-5 w-full">Сбросить фильтры</button>                     
        </div>

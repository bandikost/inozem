...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <section className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center tablet:flex-row tablet:items-start mb-20 mt-10 gap-6 w-full">
            ...
            <div className={`${showFilter ? "flex" : "hidden"} tablet:flex flex-col gap-4 items-center border border-gray-300 rounded-md bg-white px-4 max-w-[350px]`}>
                ...
                <div className="flex flex-col items-start px-6">
                    <h3 className="text-prpl mb-4 !font-normal text-left !text-2xl">Кол-во часов обучения</h3>
                        ...
                        <div className="grid grid-cols-3 gap-x-8 gap-y-3">
                                    {["576", "504", "288", "144", "72", "36", "18"].map((item) => (
                                        ...
                                        <input type="radio" name="time" value={item} checked={time === item} onChange={(e) => {
                                            ...
                                            setTimeSecondary(e.target.value)
                                            setActiveTab("programs")}}
                                            className="appearance-none w-4 h-4 border border-gray-400 rounded-sm flex items-center justify-center checked:bg-[#8D4C98] checked:border-purple-100 relative"/>
                                        <span>{item}</span>
                                        </label>
                ...
                <div className="grid grid-cols-1 w-full items-center gap-3 mt-2 px-1 pb-3">
            ...
            {filteredPrograms.length === 0 && <p className="w-full mt-10 text-zinc-700 !text-xl flex items-center justify-center"> Программ не найдено.</p>}

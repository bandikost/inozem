  ...
  return (
    <div className="flex flex-col items-center mb-12">
      <div className="w-full max-w-5xl">
        ...
        <div className="group transition-all duration-200 hover:-translate-y-1 hover:border-blue hover:shadow-lg cursor-pointer flex items-center overflow-hidden rounded-2xl border border-gray-300 bg-white transition-all duration-300 mt-4 p-5 text-lg justify-between">
            <Link href={"/files/personalize/instruction.pdf"} aria-label="Инструкция по регистрации" className="">Инструкция по регистрации</Link>
            <ArrowUpRight
                size={20}

...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <section className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center tablet:flex-row tablet:items-start mb-20 mt-10 gap-6">
            ...
            {!showFilter && <button className="button-more text-2xl" onClick={handleShowFilter}>Показать фильтры</button>}

          {showFilter && 
          <>
            <div className="flex flex-col gap-4 items-center border border-gray-300 rounded-md bg-white">
            ...
            <button className="button-more text-2xl" onClick={handleShowFilter}>Показать фильтры</button>
            </>
           }

...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <div className="mt-10 border border-gray-300 rounded-xl p-3 tablet:p-6 bg-white shadow-xl transition mb-4">
        ...
        <div className="flex flex-col computer:flex-row justify-between gap-4 items-center mt-2">
            ...
            <div className="flex flex-col items-center gap-3 mt-10 tablet:mt-0 px-2">

...
<section className="pb-20">
  ...
  <div className="grid w-full grid-cols-1 sm:grid-cols-3 rounded-2xl bg-zinc-100 p-1">

    <button
      onClick={() => setActiveTab("programs")}
      className={`px-6 py-3 text-xl !font-normal transition cursor-pointer rounded-xl ${
        activeTab === "programs"
    ...
    <div className="h-px bg-zinc-300 mx-3 sm:hidden" />
    <div className="hidden sm:block w-px bg-zinc-300 my-3" />

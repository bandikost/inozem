    ...
    <div className="mt-8 flex justify-center md:justify-end">
        ...
        <div className="grid grid-cols-1 w-full sm:grid-cols-3 rounded-2xl bg-zinc-100 p-1">
            ...
            <button
                ...
                className={`px-6 py-3 transition !font-normal cursor-pointer text-xl border-b border-zinc-300 sm:border-b-0 sm:border-r sm:border-zinc-300  ${
                    activeTab === "programs"
                        ? "bg-white shadow text-black rounded-xl"
            ...
            <button
                ...
                className={`px-6 py-3 transition !font-normal cursor-pointer text-xl border-b border-zinc-300 sm:border-b-0 sm:border-zinc-300  ${
                    activeTab === "price"
            ...
            <button
                ...
                className={`px-6 py-3 transition !font-normal cursor-pointer text-xl border-b border-zinc-300 sm:border-b-0 sm:border-l sm:border-zinc-300  ${
                    activeTab === "forms"
                        ? "bg-white shadow text-black rounded-xl"
                        : "text-zinc-600 hover:text-black"
                }`}

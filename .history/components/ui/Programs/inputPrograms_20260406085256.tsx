...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <div className="mt-10 border border-gray-300 rounded-xl p-3 tablet:p-6 bg-white shadow-xl transition">
        ...
        <div className="flex flex-col computer:flex-row justify-between gap-4 items-center mt-2">
            <div className="flex flex-col items-center gap-3 computer:ml-0 px-2">
                <h3 className="text-prpl mb-4 !font-normal text-center ">Программы по названию</h3>
            ...
            <div className="flex flex-col items-center gap-3 mt-5 tablet:mt-0 px-2">
                <h3 className="text-prpl mb-4 !font-normal text-center">Программы по образованию</h3>
                <div className="flex items-center gap-3">
                    <select value={education} onChange={(e) => setEducation(e.target.value)} name="education_level"  
                        className="flex items-center border border-zinc-400 p-2 rounded text-zinc-700 w-[240px] xs:w-[300px] !text-default !text-lg">
            ...
            <div className="flex flex-col items-center gap-3 mt-10 tablet:mt-0 px-2 pb-3">
                <h3 className="text-prpl mb-4 !font-normal text-center">Программы по направлению</h3>
                <div className="flex items-center gap-3 !text-default !text-lg">
        ...
        <div className="flex flex-col items-center mb-20">
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-10">
                ...
                {filteredPrograms.slice(0, visibleItems).map(program => (
                    <div key={program.id} className="flex flex-col justify-between border border-zinc-200 rounded-xl px-4 py-6 bg-white shadow-xl transition bg-card relative">
                    <h3 className="text-left md:text-center !font-semibold custom-text mb-4">

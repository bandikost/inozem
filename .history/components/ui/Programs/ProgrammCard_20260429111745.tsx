    ...
    return (
         <div className="flex flex-col gap-8">
                ...
                {filteredPrograms.slice(0, visibleItems).map(program => (
                    <div key={program.id} className="w-full max-w-[950px] flex flex-col justify-between border border-zinc-200 rounded-xl px-5 py-6 bg-white shadow-xl transition bg-card relative">

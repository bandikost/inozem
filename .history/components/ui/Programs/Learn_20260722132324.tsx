  ...
  return (
    <div className="flex flex-col items-center mb-12">
      <div className="w-full max-w-5xl">
        ...
        <div className="flex overflow-hidden rounded-2xl border border-gray-300 bg-white transition-all duration-300 mt-4 p-5">
            <Link href="" aria-label="Инструкция по регистрации" className="text-2xl">Инструкция по регистрации</Link>
            <ArrowUpRight
                size={20}

...
export default function InputPrograms({ programs }: { programs: ProgramRow[] }) {
    ...
    <section className="flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 mb-20 mt-10 gap-6 w-full">
            ...
            <div className={`${showFilter ? "flex" : "hidden"} tablet:flex flex-col gap-4 items-center border border-gray-300 rounded-md bg-white max-w-[300px]`}>

    ...
    <div className="border border-zinc-200 rounded-xl p-6 bg-white shadow-xl transition w-full">
        ...
        <div className="grid grid-cols-2 gap-4 items-center">
            ...
            <div className="flex flex-col items-end gap-3">
                <h3 className="text-prpl mb-4 !font-normal">Поиск программы по образованию</h3>
                <div className="flex items-center gap-3">
                    <button className="button-more" onClick={() => handleFindProgramm()}>Найти программу</button>
                    <button className="button-more" onClick={() => handleFindProgramm()}>Найти программу</button>
                </div>
        ...
        {findTotal.length === 0 ? (
            ...
            <h2 className="mt-12 text-prpl">Все программы</h2>
        )}
        ...
        {visibleItems && findTotal.map(program => (
        ...
        <button className="button-more" onClick={() => handleShowMore()}>Показать еще</button>
           </div>
        </>
    )

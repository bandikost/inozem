...
export default function FormApplication({ user, programs }: any) {
    ...
    return (
        <form onSubmit={handleSubmit} className="border border-gray-300 py-4 px-6 rounded-md flex flex-col gap-4 w-[450px]">
            ...
            className="border border-zinc-300 p-2 w-full rounded text-default !font-normal">
            ...
            <select required className="border py-1 px-2 border-gray-300 rounded-md w-[400px] !font-normal">

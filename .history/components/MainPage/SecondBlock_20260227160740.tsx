              ...
              <div className="border border-dotted border-zinc-300 rounded shadow-2xl">
                ...
                <hr className="border-zinc-300" />
                    ...
                    <ul className="w-full mt-4 text-center grid grid-cols-3 items-center justify-center gap-4 p-4">
                        <li className="text-blue text-3xl border border-gray-200 py-4 rounded-xl shadow-xl">{`>`}17 лет <p className="text-default text-sm">Предоставляем качество</p></li>
                        
                        <li className="text-prpl text-3xl border border-gray-200 py-4 rounded-xl shadow-xl">

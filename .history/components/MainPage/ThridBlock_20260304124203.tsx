                        ...
                        {teachers.map(teach => (
                            <li key={teach.id}>
                                <div className="flex flex-col tablet:flex-row gap-6 items-center py-2 ">
                                    ...
                                    <ImageWithSkeleton src="https://storage.yandexcloud.net/inozemstorage/main/banner/od.png" alt="Преподаватель месяца" wrapperClassName="max-w-[50px] max-h-[50px] " aspect="1/1"/>

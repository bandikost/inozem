...
export default async function FirstBlock() {
  ...
  <div className="grid gap-8 grid-cols-1 justify-center items-center md:grid-cols-[1.1fr_1.4fr]">

   
      <ImageWithSkeleton
        src="https://storage.yandexcloud.net/inozemstorage/main/banner/1.jpg"
        alt="Изображение академии"
        wrapperClassName="max-w-[600px] max-h-[600px] min-w-[300px] min-h-[300px]"
        aspect="4/5"
      />

                ...
                <div className="grid grid-cols-2 gap-3 py-4">
                   ...
                   {cards.map((card, index) => (
                    <div key={index} className={` rounded-xl shadow border border-gray-300`}>
                        <div className={`grid grid-cols-1 gap-2 p-3 md-custom-flex-col items-start`}>

                         {card.img && <ImageWithSkeleton src={card.img} alt="Изображение академии" wrapperClassName="w-[80px] sm:w-[80px] h-[80px] sm:h-[80px]" aspect="1/1" /> }

                        <div className={`grid grid-cols-1 gap-2 px-3  items-start md-custom-items-center`}>

    ...
    return (
        <section className="grid tablet:flex gap-6 items-center justify-center tablet:items-start px-4">
                ...
                <div className="border-2 border-zinc-300 mt-4 rounded-xl shadow-2xl bg-white">
                        <Image alt="Изображение академии на главной странице" width={100} height={100} src={"https://storage.yandexcloud.net/inozemstorage/main/banner/%D0%9E%D0%9F%D0%95%D0%A0%D0%90%D0%A6%D0%98%D0%9E%D0%9D%D0%9D%D0%9E%D0%95%20%D0%94%D0%95%D0%9B%D0%9E.png"} 
                        className="max-w-[660px] w-full tablet:w-114 tablet:h-114 object-unset rounded-xl "  />
                </div>

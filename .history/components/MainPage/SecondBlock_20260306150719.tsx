    ...
    return (
        <section className="w-full flex flex-col  gap-4 mt-20">
            ...
            <div className="flex flex-col items-center tablet:items-start px-4">
                <p className="mb-20 !text-2xl">Предлагаю сделать страницу FAQ или где-то разместить на видном месте. Звонят и задают по 15 раз одни и те же вопросы!!!!!!</p>
                <h2 className="text-prpl">О нас</h2>
                <p className="mt-2 text-center">Более подробная информация об академии в разделе <Link href={"/about"} className="">"О нас"</Link></p>
            </div>

...
export default async function FirstBlock() {
    ...
    return (
        <section className="grid tablet:flex gap-6 items-center justify-center tablet:items-start px-4">
                ...
                <div className="border-2 border-zinc-300 mt-4 rounded-xl shadow-2xl bg-white p-4">
                  <ImageWithSkeleton
                    src="https://storage.yandexcloud.net/inozemstorage/main/banner/ОПЕРАЦИИОННОЕ%20ДЕЛО.png"
                    alt="Изображение академии"
                    wrapperClassName="max-w-[520px]"
                    aspect="16/9"
                  />
                </div>

...
const cards = [
  ...
  },
  {
   ...
   {
    title: "Акции",
    description: "Специальные/Уникальные предложения",
                ...
                <div className="grid  gap-3 py-4">
                   ...
                   {cards.map((card, index) => (
                    <div key={index} className={` rounded-xl shadow border border-gray-300 ${index >= 2 ? "md:col-span-1" : "lg:col-span-2 "}`}>
                        <div className={`flex flex-col sm:flex-row p-3 ${index >= 2 ? "md-custom-flex-col items-start sm:items-center flex-col sm:flex-row" : ""}`}>

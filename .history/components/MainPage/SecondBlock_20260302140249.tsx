    ...
    return (
        <section className="flex flex-col mt-10">
            ...
            <div className="flex flex-col items-start px-4">
                <h1>О нас</h1>
                <p>Какая то информация защпшсгшподпкылжад asdasdasd</p>
            </div>
                 
            <ul className="w-full mt-4 text-center grid grid-cols-3 items-center justify-center gap-4 p-4">

                <li className="text-blue text-3xl border border-gray-200 py-8 rounded-xl shadow-xl">
                ...
                <li className=" text-3xl border border-gray-200 py-8 rounded-xl shadow-xl">

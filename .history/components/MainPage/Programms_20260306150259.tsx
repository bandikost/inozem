...
export default async function Programms() {
    ...
    return (
        <section className="w-full flex flex-col  gap-4 mt-20"> 
            <div className="flex flex-col items-center justify-center tablet:items-start px-4">
                ...
                <Link href={"/learning"} className="!text-lg flex items-center justify-center mt-4 hover:opacity-80 hover:underline">Перейти в общий раздел обучения</Link>
            </div>

                            ...
                            <li key={teach.id}>
                                <div className="flex items-start px-2 py-2">
                                   ...
                                   <div className="flex flex-col items-start px-6">
                                        ...
                                        <button class="relative px-4 py-2 mt-4.5 rounded text-white overflow-hidden">
  <span class="absolute inset-0 bg-[#533282] transition-opacity duration-1000 hover:opacity-0"></span>
  <span class="absolute inset-0 bg-gradient-to-r from-[#533282] to-[#3CA7B5] opacity-0 transition-opacity duration-1000 hover:opacity-100"></span>
  <span class="relative z-10">Кнопка</span>
</button>
                                   </div>
                                </div>
                            </li>

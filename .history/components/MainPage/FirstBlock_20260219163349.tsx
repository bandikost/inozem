        ...
        <section className="border-2 border-dotted border-zinc-300 pb-8 mt-8 rounded shadow-2xl bg-white">
            <div className="grid grid-cols-2 justify-center px-6 py-4">
                ...
                <div className="flex flex-col items-center gap-4 mt-4">
                    ...
                    <Link href="/" className="button-blue text-center w-50 py-2">Подать заявку</Link>
                    <Link href="/register" className="button-prpl text-center w-50 py-2">{token ? "Личный кабинет" : "Бесплатная регистрация"}</Link>
                </div>
            </div>

                            ...
                            <li key={teach.id}>
                                <div className="flex items-start px-2 py-2">
                                   ...
                                   <div className="flex flex-col items-start px-6">
                                        ...
                                        <button className="bg-[#533282] text-white px-4 py-2 mt-4.5 rounded transition-colors duration-1000 
                                        hover:bg-gradient-to-r hover:from-[#533282] hover:to-[#3CA7B5]">

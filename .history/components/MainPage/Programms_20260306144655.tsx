                        ...
                        {programs.map((p) => (
                            <div key={p.id} className="flex flex-col justify-between gap-8 bg-white p-4 rounded-lg shadow-md border border-gray-300">
                                ...
                                <div className="grid gap-1">
                                    <p className="text-prpl"><strong className="text-blue">Даты:</strong> {p.dates}</p>
                                    <p className="text-prpl"><strong className="text-blue">Образование:</strong> {p.education}</p>
                                    <p className="text-prpl"><strong className="text-blue">Направления:</strong> {p.specialization}</p>
                                </div>

        ...
        <section className="grid tablet:flex gap-6 items-center justify-center tablet:items-start px-4">
                ...
                <div className="grid  gap-3 py-4">
                   ...
                   {cards.map((card, index) => (
                    <div key={index} className={` rounded-xl shadow border border-gray-300 lg:col-span-2`}>
                        <div className={`flex flex-col sm:flex-row p-3 md-custom-flex-col items-start sm:items-center flex-col sm:flex-row`}>

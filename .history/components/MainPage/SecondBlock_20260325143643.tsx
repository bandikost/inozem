    ...
    return (
        <section className="w-full flex flex-col  gap-4 mt-20">
            ...
            <ul className="w-full max-w-full mt-4 text-center grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-center p-4">
                ...
                <li className="w-full max-w-[20px] md:max-w-full mx-auto text-blue text-3xl border border-gray-300 py-10 tablet:py-8 rounded-xl shadow-xl">
                    Более {users.length} <p className="text-default text-sm">Обучающихся</p>
                </li>

                <li className="w-full max-w-[20px] md:max-w-full mx-auto text-prpl text-3xl border border-gray-300 py-10 tablet:py-8 rounded-xl shadow-xl ">
                ...
                <li className="w-full max-w-[20px] md:max-w-full mx-auto text-3xl border border-gray-300 py-8 rounded-xl shadow-xl">

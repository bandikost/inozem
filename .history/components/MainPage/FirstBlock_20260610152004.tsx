    ...
    return (
        <section className="grid tablet:flex gap-6 items-center justify-center tablet:items-start px-4">
                ...
                <div className="border-2 border-zinc-300 mt-4 rounded-xl shadow-2xl bg-white">
                  <div className="relative w-full h-full max-w-[520px] max-h-[520px] aspect-[16/9]">
                    <ImageWithSkeleton
                ...
                <div className="grid  gap-3 py-4">
                   ...
                   .slice(2, 4)
                   .map((card, index) => (
                    <div key={index} className={` rounded-xl shadow border border-gray-300 grid  grid-cols-2`}>

                        <div className={`flex justify-between items-center p-3  md-custom-flex-col items-center`}>

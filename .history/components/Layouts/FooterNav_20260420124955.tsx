    ...
    <div className="w-full max-w-[1200px] mx-auto px-2 ">
      <div className="footer-nav">
        ...
        <div className='text-start sm:text-center mt-10 flex items-center justify-center gap-6 text-sm'>
              ...
              <img src="/Images/icons/vk.svg" alt="Группа Вконтакте Академии Инозмемцева" loading='lazy' width={40} height={40} /><a href="https://vk.com/inozem.online">asdasd</a>
              <img src="" alt="" loading='lazy' /><a href="https://dzen.ru/inozem.online">asdasd</a>
        </div>

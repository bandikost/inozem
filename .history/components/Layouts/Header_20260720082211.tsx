  ...
  const items = [
    {
      ...
      //  { label: "Блог", href: "/blog", ariaLabel: "Наш Блог" },
        ...
        { label: "Сотрудники", href: "/employees", ariaLabel: "Сотрудники" },
         { label: "Сведения об образовательной организации", href: "/info", ariaLabel: "Сведения об образовательной организации" },
      ]
    },
    {
      ...
      textColor: "#fff",
      links: [
        { label: "Обучение", href: "/programs", ariaLabel: "Обучение" },

      ...
      <div className="footer-nav">
       ...
       <div className='text-start sm:text-center mt-10 flex items-center justify-center gap-6 text-sm'>
        <a href="https://dzen.ru/inozem.online" target="_blank" rel="noopener noreferrer">
          <img src="/Images/icons/dzen.svg" alt="Группа Дзен Академии Иноземцева" loading="lazy" className='opacity-60' width={40} height={40} />
        </a>
        <a href="https://vk.com/inozem.online" target="_blank" rel="noopener noreferrer">
          <img src="/Images/icons/vk.svg" alt="Группа Вконтакте Академии Иноземцева" loading="lazy" width={50} height={50} />
        </a>
        <a href="https://max.ru/inozem.online" target="_blank" rel="noopener noreferrer">
          <img src="/Images/icons/max.svg" alt="Группа Макс Академии Иноземцева" loading="lazy" width={40} height={40} />
        </a>
      </div>

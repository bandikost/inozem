    ...
    <section className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
              <img className="object-fit" width={60} height={60}src="/Images/about/inozemtsev.png" className="mt-1 float-left w-36 h-36 mr-8 rounded object-cover [shape-outside:circle(50%)]"  alt="Федор Иванович Иноземцев"/>
      ...
      <div className="border-2 border-dotted border-zinc-300 my-8 rounded shadow-2xl bg-white px-6 py-3">
        ...
        <ul className="grid gap-6 grid-cols-6 mt-4 text-md">
          <a href="https://video.organum-visus.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/ovis.png" /></a>
								<a href="http://vrachi-spb.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/roo_vrachi.png" /></a>
								<a href="http://www.acspb.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/acspb.png" /></a>
								<a href="http://olympus.com.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/olympus.png" /></a>
								<a href="http://www.ivrach.com" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/ivrachi_logo.png" /></a>
								<a href="http://gematolog.com" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/gematolog.jpg" /></a>
								
								<a href="http://bewinner.biz" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/bw.png" /></a>
								<a href="http://www.isoseroclon.ru" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/mediclon.png" /></a>
								<a href="http://nwcspb.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="https://nwcspb.ru/image/logo/logo_nwc.png" /></a>
								
								<a href="https://spbmrc.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/news/1583854926MRC.png"  alt="" /></a>
								
								<a href="https://www.sogaz-clinic.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/sogaz.png"/></a>
								<a href="http://loposm.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/passd.jpg" alt="" /></a>
								<a href="https://rusal.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/Русал.png" alt="" /></a>
								<a href="https://efamedica.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/efa-medica.png" alt="" /></a>
								<a href="https://www.medison.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/npm/2025/img/медиэйс.webp" alt="" /></a>
								<a href="https://www.jnjmedicaldevices.com/en-US/companies/ethicon" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/ethicon.png" alt="" /></a>
								<a href="https://www.lintex.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/lintex.png" alt=""/></a>
								<a href="https://spb-maneken.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/medtech.png" alt=""/></a>
								<a href="https://medsestre.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/rams.png" alt=""/></a>
								<a href="https://2440202.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/solt.png" alt=""/></a>
								<a href="https://www.karlstorz.com/ru/ru/index.htm" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/storz.png" alt="" /></a>
								<a href="https://xn--b1aecboaym3f.xn--p1ai/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/vmedrf.png" alt="" /></a>
								<a href="http://www.vodokanal.spb.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/vodokanal.png" alt="" /></a>
								<a href="https://medsyst.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/medsyst.jpeg" alt="" /></a>
								<a href="http://fondendomir.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/endomir.webp" alt="" /></a>
								<a href="https://www.martinex.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/MARTINEX_LOGO MT.png" alt="" /></a>
								<a href="http://medcomtech.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="http://www.medcomtech.ru/img/elements/verh_.png"  alt=""/></a>
        </ul>
      </div>
      ...
      <div className="border-2 border-dotted border-zinc-300 my-8 rounded shadow-2xl bg-white px-6 py-3">
        ...
        <ul className="grid gap-6 grid-cols-6 mt-4 text-md">
          <a href="https://medsi.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/image002.jpg" /></a>
									...
									<a href="https://www.medswiss.ru/" target=""><img className="object-fit" width={60} height={60}src="https://www.medswiss.ru/local/img/logo-new.svg" alt=""/></a>
									<a href="http://www.verficlinic.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://pp.userapi.com/c636721/v636721809/3948c/g5ssFoGcIzQ.jpg" alt=""/></a>
									<a href="http://alexhospital.ru" target="_blank"><img className="object-fit" width={60} height={60}src="http://alexhospital.ru/assets/images/FrontPageGraphics/logo.gif" alt=""/></a>
									<a href="https://rrcrst.ru" target="_blank"><img className="object-fit" width={60} height={60}src="https://rrcrst.ru/content/index/logo.png" alt=""/></a>
									<a href="https://spbkbran.ru" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/spbkran.png" alt=""/></a>
									<a href="https://lucaclinic.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://sun9-6.userapi.com/impg/ob4rO6-XvmKTUEzlWiu8RoJhmfKTJ4z3ws14vg/4s7cmj08b0w.jpg?size=1179x809&quality=95&sign=984e05c2103e1c57177b568f4f57704d&type=album" alt=""/></a>

									<a href="http://amclinic.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="http://amclinic.ru/theme/amclinic/images/logo.png" alt=""/></a>
									<a href="http://lugamb.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/lugamb.jpg" alt=""/></a>
									<a href="https://p107.spb.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/p107.jpg"  alt="" /></a>
									<a href="https://www.gosmed.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://www.gosmed.ru/upload/CMedc2/e03/fdr4vemrrtirqn1ulu2rsi2uy2vmwivn.png"  alt=""/></a>
									<a href="https://www.zdrav.org/"><img className="object-fit" width={60} height={60}src="/images/site/ezs.png"  alt=""/></a>
                  <a href="http://rihophe.ru/"><img className="object-fit" width={60} height={60}src="/images/site/logo@2x.png"  alt="" /></a>
									<a href="https://oren.medguard.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://oren.medguard.ru/local/templates/medguard/images/static/logo.svg" alt=""/></a>
									<a href="https://spbu.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://spbu.ru/themes/spbgu/markup/dist/img/logo-big.svg" alt="" /></a>
									<a href="https://roddom10.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/rd10.jpg" alt=""/></a>
									<a href="http://botkinhosp.org/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/botkin.png" alt=""/></a>
									<img className="object-fit" width={60} height={60}src="/images/site/sk.png" alt=""/>
									<a href="https://baltclinic.ru/company/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/baltmed.png" alt=""/></a>
									<a href="http://viamedika.com/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/vm.png" alt=""/></a>									
									<a href="https://cispb.com/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/istochnik.jpg" alt=""/></a>									
									<a href="https://happy-klinika.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="https://happy-klinika.ru/local/templates/klinika/images/logo.svg" alt=""/></a>
									...
									<a href="https://nzabota.ru" target="_blank"><img className="object-fit" width={60} height={60}src="https://nzabota.ru/img/logo.svg" alt=""/></a>
        </ul>
      </div>
    </section>
  )

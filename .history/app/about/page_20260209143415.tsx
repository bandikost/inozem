  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
            ...
            <ul className="mt-4 grid gap-2">«ЧОУ ДПО «Академия медицинского образования им. Ф.И.Иноземцева» самостоятельно осуществляет образовательный процесс, разрабатывает, принимает и реализует программы дополнительного образования с учетом:

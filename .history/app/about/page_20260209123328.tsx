    ...
    <div className="flex justify-between gap-8">
      ...
      <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
        <h1 className="text-prpl font-semibold text-3xl mt-2">Юридическая информация</h1>  
         ...
         <p className="text-default text-sm mt-2">Частное образовательное учреждение дополнительного профессионального образования «Академия медицинского образования имени Федора Ивановича Иноземцева»</p>
      </div>

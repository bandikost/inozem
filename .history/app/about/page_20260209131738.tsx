  ...
  <section className="flex flex-col">
    ...
    <div className="grid grid-cols-2 gap-8">
      <div className="flex flex-col px-6">
        <h1 className="text-prpl font-semibold text-3xl mt-2 flex items-center"><Info className="mr-2" />Юридическая информация</h1>  
        <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
      ...
      <div className="flex flex-col px-6">
        <h1 className="text-blue font-semibold text-3xl mt-2 flex items-center"><File className="mr-2"/>Документы Академии</h1>
        <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">      

...
// Компонент разворачиваемого блока
    ...
    <section className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
            <h2 className="text-blue font-semibold text-2xl mt-8">
            ...
            <ul className="grid gap-4 underline mt-4 text-blue">
              {documents.map((doc, i) => (
                <li key={i}>
                  <Link href={doc.link} target="_blank" rel="noopener noreferrer">{doc.name}</Link>
                </li>
              ))}
            </ul>
          </div>

          {/* Разворачиваемые блоки с отдельным state */}
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
            <h2 className="text-blue font-semibold text-2xl mt-8">Бюджетные сметы образовательной организации:</h2>
            <hr className="border-zinc-300 w-full h-2" />
            <ToggleBlock title="Бюджет 2024">asdasdasd</ToggleBlock>

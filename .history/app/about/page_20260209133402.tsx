...
const documents = [
  ...
  { name: "Поступление и расходование финансовых и материальных средств 2014 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2015 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2016 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2017 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2018 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2019 год", link: "/files/about/reshenie.pdf" },
  { name: "Поступление и расходование финансовых и материальных средств 2020 год", link: "/files/about/reshenie.pdf" },
];
...
function ToggleBlock({ title, children }: { title: string, children: React.ReactNode }) {
  ...
  return (
    <div className="mt-4">
      ...
      {open && <div className="px-6 mt-2 text-default">{children}</div>}
    </div>
  )
}
    ...
    <section className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
            <h2 className="text-blue font-semibold text-2xl mt-4">Бюджетные сметы образовательной организации:</h2>
            <hr className="border-zinc-300 w-full h-2" />
            <ToggleBlock title="Бюджет 2024">
              
            </ToggleBlock>
            <ToggleBlock title="Бюджет 2025">s78fuk</ToggleBlock>
          </div>
        </div>
      </div>

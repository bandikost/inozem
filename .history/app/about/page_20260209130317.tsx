      ...
      <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
        ...
        <hr className="border-zinc-300 w-full h-2" />
          <ul className="grid gap-4">
            ...
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Лицензия на осуществление образовательной деятельности</Link></li>
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Выписка из реестра лицензий</Link></li>
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Свидетельство о гос. регистрации</Link></li>
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Санитарно-эпидемиологическое заключение</Link></li>
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Заключение о соответствии требованиям пожарной безопасности</Link></li>
            <li><Link href={"/files/about/"} target="_blank" rel="noopener noreferrer">Решение Учредителя</Link></li>
          </ul>
      </div>
    </div>

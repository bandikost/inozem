    ...
    <div className="grid grid-cols-2 gap-8">
      ...
      <div className="flex flex-col mt-8">
        ...
        <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">      
          ...
          <hr className="border-zinc-300 w-full h-2" />
          <div>
            <button onClick={handleOpen} className="text-prpl mt-4 text-2xl cursor-pointer">Бюджетные сметы образовательной организации: ({active ? "Свернуть" : "Развернуть"})</button>

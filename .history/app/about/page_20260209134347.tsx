...
const legalInfo = [
  {
    ...
    text: "Частное образовательное учреждение дополнительного профессионального образования «Академия медицинского образования имени Федора Ивановича Иноземцева»"
  },
  {
    title: "Сокращенное наименование",
    text: "ЧОУ ДПО «Академия медицинского образования им. Ф.И.Иноземцева»"
  },
  {
    title: "Полное наименование образовательной организации на английском языке",
    text: "Private Educational Institution of Supplementary Education «Academy of Medical Education named after F.I.Inozemtsev»"
  },
  {
    title: "Дата создания образовательной организации",
    text: "27 января 2009 года"
  },
  {
    title: "Лицензия, аккредитация",
    text: "Лицензия на право ведения образовательной деятельности - регистрационный № 2337, выдана Комитетом по образованию Правительства Санкт-Петербурга 16 ноября 2016 года, серия 78Л01 №0000752"
  },
  {
    title: "Учредитель образовательной организации",
    text: "Акционерное общество «Современные медицинские технологии», являющееся юридическим лицом по законодательству РФ, место нахождения: 190013, Санкт-Петербург, Московский пр., 22, зарегистрированное Межрайонной инспекцией Федеральной налоговой службы №15 по Санкт-Петербургу 05.06.2008г. за основным государственным регистрационным номером 1089847230417, о чем выдано свидетельство Серия 78 №006981724"
  },
  {
    title: "Директор Академии",
    text: "Кощеева Наталья Александровна"
  },
];
...
const regulations = [
  {
    name: "Положение об Общем собрании работников ЧОУ ДПО «Академия медицинского образования им. Ф.И. Иноземцева»", 
    link: "/files/about/regulations/obshchee_sobranie_rabotnikov.pdf"},
  {
    name: "Положение о Педагогическом совете",
    link: "/files/about/regulations/pedagogicheskiy_sovet.pdf",
  },
  {
    name: "Положение об информационной открытости",
    link: "/files/about/regulations/informatsionnaya_otkrytost.pdf",
  },
  {
    name: "Положение по организации и осуществлению образовательной деятельности",
    link: "/files/about/regulations/organizatsiya_obrazovatelnoy_deyatelnosti.pdf",
  },
  {
    name: "Положение об обработке и защите персональных данных",
    link: "/files/about/regulations/personalnye_dannye.pdf",
  },
  {
    name: "Политика конфиденциальности",
    link: "/files/about/regulations/politika_konfidentsialnosti.pdf",
  },
  {
    name: "Правила приема, отчисления и восстановления обучающихся",
    link: "/files/about/regulations/priemy_otchislenie_vosstanovlenie.pdf",
  },
  {
    name: "Положение о порядке проведения сертификационного экзамена при реализации дополнительных профессиональных программ",
    link: "/files/about/regulations/sertifikatsionnyy_ekzamen.pdf",
  },
  {
    name: "Положение о формах, периодичности и порядке текущего контроля успеваемости",
    link: "/files/about/regulations/tekushchiy_kontrol_uspevaemosti.pdf",
  },
  {
    name: "Правила внутреннего распорядка обучающихся",
    link: "/files/about/regulations/vnutrenniy_rasporyadok_obuchayushchikhsya.pdf",
  },
  {
    name: "Режим занятий обучающихся",
    link: "/files/about/regulations/rezhim_zanyatiy.pdf",
  },
  {
    name: "Правила внутреннего трудового распорядка",
    link: "/files/about/regulations/trudovoy_rasporyadok.pdf",
  },
  {
    name: "Положение об электронной информационно-образовательной среде",
    link: "/files/about/regulations/eios.pdf",
  },
  {
    name: "Сведения о научно-педагогическом совете",
    link: "/files/about/regulations/nauchno_pedagogicheskiy_sovet.pdf",
  },
];
  ...
  return (
    <div className="mt-4 px-4">
      <button
        ...
        className=" text-prpl text-xl cursor-pointer hover:underline"
      >
  ...
  return (
    <section className="flex flex-col">
      ...
      <p className="text-default text-sm p-1 mt-8">
        Раздел подготовлен в соответствии с Правилами размещения информации на официальном сайте образовательной организации...
      </p>
    </section>
  )
}

    ...
    <section className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-10 rounded shadow-2xl bg-white px-6 py-3 grid gap-4">
            <ToggleBlock title="Бюджетные сметы образовательной организации:">
             ...
             <Link className="mt-10 px-6" href={""}>Отчет о результатах самообследования за 2015 год</Link>
          </div>
        </div>
      </div>

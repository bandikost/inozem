    ...
    <section className="flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border-2 border-dotted border-zinc-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-3">
              <img src="/Images/about/inozemtsev.png" className="mt-4 float-left w-37 h-37 mr-4 rounded-full object-cover border [shape-outside:circle(50%)]"  alt="Федор Иванович Иноземцев"/>

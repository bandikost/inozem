...
export async function POST(req: NextRequest) {
    ...
    const [result] = await db.query<ResultSetHeader>(
      `INSERT INTO application (last_name, name, patronymic, phone, email, education_level, specialization, programm_name, created_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [last_name,  name, patronymic, phone, email, education_level, specialization, programm_name, created_at]
    )

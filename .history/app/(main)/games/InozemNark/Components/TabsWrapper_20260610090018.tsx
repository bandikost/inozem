                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="divide-y divide-gray-200 ">
                        ...
                        <div key={l.id} className={`grid grid-cols-12 items-center px-4 py-3 hover:bg-gray-50 transition ${userRank === index + 1 ? 'bg-prpl' : ''}`}>
                            ...
                            <div className={`col-span-2 font-bold text-gray-700 ${userRank === index + 1 ? 'text-white hover:text-gray-700' : ''}`}> #{index + 1}</div>

                            <div className="col-span-7 flex flex-col">
                                <span className={`font-medium text-default text-lg ${userRank === index + 1 ? '!text-white text-white hover:text-gray-700' : ''}`}>

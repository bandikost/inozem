    ...
    return (
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-2 items-start gap-8 mt-8 ">
        ...
        <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white pt-3 flex flex-col">
          <h3 className="text-prpl font-semibold !text-2xl p-4 flex gap-2 ml-2 flex-col items-center text-center"><GraduationCap size={30} strokeWidth={1.5} /> Программы обучения</h3>
      ...
      <div className="pt-3 grid gap-6 grid-cols-1 tablet:grid-cols-2 items-center my-10">
        <LogoutButton /> 
        <Link className="flex p-8 justify-center text-lg sm:text-2xl rounded-md items-center gap-1 hover:opacity-70 shadow-2xl bg-prpl !text-white" href="/dashboard/">

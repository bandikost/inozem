    ...
    >
      ...
      {textarea ? (
        <textarea
          ...
          rows={5}
          className="min-h-[120px] resize-y rounded-xl border border-gray-300 px-4 py-3 outline-none transition focus:border-prpl"
        />
      ) : (
        <input
          type={type}
          ...
          className="rounded-xl border border-gray-300 px-4 py-3 outline-none transition focus:border-prpl"
        />
      )}

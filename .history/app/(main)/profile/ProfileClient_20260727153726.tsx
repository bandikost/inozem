...
export default function ProfileClient({programs, user} : Props) {
    ...
    <div className="container max-w-6xl px-4 my-27">
      ...
      <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white pt-3 flex flex-col h-full">
        <h3 className="text-prpl font-semibold !text-2xl p-4 flex gap-2 ml-2 text-center justify-center"><Star size={30} strokeWidth={1.5} /> Впечатления</h3>
          <ul className="flex flex-col justify-center items-center gap-2 mt-10">
            ...
            <li className="px-4 text-gray-500 text-xl mt-3">Помогите нам стать лучше</li>
          </ul>
      </div> 

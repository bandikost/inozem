...
export default function ProfileClient({programs, user, tests} : Props) {
  ...
  <div className="mt-8 flex max-h-[300px] flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_12px_40px_rgba(15,23,42,0.08)]">
    ...
    <div className="mt-6 rounded-2xl border border-dashed border-slate-200 bg-slate-50/70 px-4 py-5 ">
     ...
     <LoadingLink className="w-full button-more mt-8" href="/proposition" aria-label="Переход к форме предложения">Перейти к форме</LoadingLink>
      ...
      <div className="h-1 bg-gradient-to-r from-[#7A4385] via-[#8D4C98] to-[#A75BB3]" />
          ...
          <div className="p-6 md:p-8 flex flex-col justify-center max-h-[300px]">
        ...
        <div className="mt-8 flex max-h-[300px] justify-center  flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_12px_40px_rgba(15,23,42,0.08)]">
          <div className="h-1 h-1 bg-gradient-to-r from-[#7A4385] via-[#8D4C98] to-[#A75BB3]" />
          <div className="p-6 md:p-8 flex flex-col h-full justify-center">
      ...
      {!user.isTeacher && (
        ...
        <LoadingLink href="/profile/change-password" className="w-full mt-6 button-more">Изменить информацию</LoadingLink>
        </div>
      </div>
      )}

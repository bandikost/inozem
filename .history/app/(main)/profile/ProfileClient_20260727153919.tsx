      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Ваши активные и завершённые программы
          </p>
        </div>
      </div>
          ...
          {programs.length > 2 && (
            <div className="mt-6 pt-2">
              <button
                ...
                className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-sm font-medium text-slate-700 transition-all hover:border-violet-300 hover:bg-violet-50 hover:text-violet-700"
              >

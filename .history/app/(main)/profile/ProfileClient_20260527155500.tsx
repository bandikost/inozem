...
export default function ProfileClient({programs, user} : Props) {
    ...
    return (
      ...
      <div className="pt-3 grid gap-6 grid-cols-1 tablet:grid-cols-2 items-center my-10">
        <LogoutButton /> 
        <Link className="flex p-8 justify-center text-xl sm:text-2xl rounded-md items-center gap-1 hover:opacity-70 shadow-2xl bg-prpl !text-white" href="/dashboard/">

...
export default async function ProfileClient({programs, user, tests} : Props) {
    ...
    const res = await fetch(`/api/pruffme/webinars`, { method: "GET" } )
  ...
  <div className="p-6 md:p-8 flex h-full flex-col">
    <div className="flex items-center gap-3">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Ближайшие вебинары (Доступ к вебинарам имеют только те пользователи, которые оплатили)
        </p>
      </div>
    </div>

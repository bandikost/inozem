          ...
          {!user.isTeacher && (
            <div className="flex flex-col">
              <div className="flex items-center mt-4">
                <Book className="w-5 mr-1 text-prpl p-4" />
                <h2 className="text-prpl font-semibold text-2xl p-4">
                  Слушатель
                </h2>
              </div>
              ...
              <LogoutButton />
              {user.isAdmin && (
                <div className="mt-10 px-2 border border-gray-300 mt-8 rounded shadow-2xl bg-white">

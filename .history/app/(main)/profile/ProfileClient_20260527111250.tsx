...
export default function ProfileClient({programs, user} : Props) {
    ...
    return (
      ...
      <div className="pt-3 grid gap-4 grid-cols-2 items-center mt-20">
        <Link className="flex p-8 justify-center w-80 text-2xl rounded-md items-center gap-1 hover:opacity-70 shadow-2xl bg-prpl !text-white" href="/dashboard/">

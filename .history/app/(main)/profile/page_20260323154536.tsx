            ...
            <div className="flex flex-col">
              ...
              {user.isAdmin && (
                <div className="-ml-1.5 ">
                  <Link href={'/dashboard/manager'} className="text-lg hover:underline !text-white bg-prpl px-4 py-1 border-y border-gray-300 shadow-xl rounded">Перейти в админку</Link>
                </div>
              )}

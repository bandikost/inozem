...
export default async function ProfilePage() {
  ...
  return (
    <section className="flex flex-col justify-center items-center px-4">
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-3 gap-8 mt-8 items-start h-full min-h-[300px]">
  ...
  {programs.map(p => {
    ...
    return (
      ...
      {user.isTeacher ? ( 
        <div className="grid w-full items-center grid-cols-1 md:grid-cols-2 gap-4 border border-gray-300 mt-8 mb-14 rounded shadow-2xl bg-white"> 
       {/* {user.photo_url && ( 
        ...
        <div className="border border-gray-300 mt-8 mb-14 rounded shadow-2xl bg-white h-auto">
          {!user.isTeacher && (

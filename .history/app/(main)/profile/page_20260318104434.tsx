  ...
  return (
    <section className="flex flex-col justify-center items-center px-4">
      ...
      {user.isTeacher ? ( 
        ...
        <div className="mt-10 border border-gray-300 mt-8 rounded shadow-2xl bg-white w-full px-6">
          <Link href={'/dashboard'} className="text-lg hover:underline">Перейти в админку</Link>
        </div>
      )}
            </div>
          )}

      ...
      <div className="border-2 border-dotted border-zinc-300 mt-8 rounded shadow-2xl bg-white px-6 py-3">
        <div className="grid grid-cols-2">
            ...
            <ul className="text-default text-lg py-4">   
              <li><strong>Фамилия:</strong> <span className="ml-2">{user.last_name}</span></li>
              <li><strong>Имя:</strong><span>{user.name}</span></li>
              <li><strong>Отчество:</strong><span>{user.patronymic ?? ""}</span></li>
            </ul>
            <LogoutButton />
        </div>
        </div>
        ...
        <div className="border-2 border-dotted border-zinc-300 mt-8 rounded shadow-2xl bg-white px-6 py-3">
          <div className="grid grid-cols-2">
            <h2 className="text-prpl font-semibold text-2xl">Программы обучения</h2>
          </div>

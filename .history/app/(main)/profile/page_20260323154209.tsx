        ...
        <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white">
          {!user.isTeacher && (
            <div className="flex flex-col">
              ...
              {user.isAdmin && (
                <div className=" px-4 border-y border-gray-300 shadow-2xl bg-prpl">
                  <Link href={'/dashboard/manager'} className="text-lg hover:underline !text-white">Перейти в админку</Link>
                </div>
              )}

...
export default function ProfileClient({programs, user} : Props) {
    ...
    return (
      ...
      <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white pt-3 flex flex-col mt-20">
        <Link className="flex p-8 border border-gray-300 w-1/2 text-2xl" href="/dashboard/"><LogOutIcon /> Перейти в админку</Link>
        <LogoutButton /> 
      </div>

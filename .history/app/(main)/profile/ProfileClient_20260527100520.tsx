...
export default function ProfileClient({programs, user} : Props) {
    ...
    return (
      ...
      <div className="mt-8  pt-3 flex flex-col mt-20">
        <Link className="flex p-8 border border-gray-300 justify-center text-2xl rounded-md items-center text-center" href="/dashboard/"><LogOutIcon /> Перейти в админку</Link>
        <LogoutButton /> 
      </div>

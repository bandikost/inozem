        ...
        <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white">
          {!user.isTeacher && (
            <div className="flex flex-col">
              ...
              {user.isAdmin && <Link href={'/dashboard/manager'} className="text-lg hover:underline !text-white bg-prpl px-4 border-y border-gray-300 shadow-2xl ">Перейти в админку</Link>}

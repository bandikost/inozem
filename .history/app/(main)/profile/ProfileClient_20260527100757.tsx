...
export default function ProfileClient({programs, user} : Props) {
    ...
    return (
      ...
      <div className="mt-8 gap-6 pt-3 flex flex-col items-center justify-center mt-20">
        <Link className="flex p-8 border border-gray-300 justify-center w-1/2 text-2xl rounded-md items-center text-center hover:opacity-70 shadow-2xl button-more" 

...
export default async function ProfilePage() {
  ...
  return (
    <section className="flex flex-col justify-center items-center px-4 h-full">
      <h1 className="text-prpl font-semibold text-center mt-28">Личный кабинет</h1>flex flex-col justify-center items-center px-4 h-full
      ...
      {user.isTeacher ? ( 
        ...
        <div className="border border-gray-300 mt-8 mb-30 rounded shadow-2xl bg-white h-full flex flex-col ">
          {!user.isTeacher && (

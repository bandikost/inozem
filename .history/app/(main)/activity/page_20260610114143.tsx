        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {upcomingActivities.map(act => (
              <div key={act.id} className="group rounded-xl border border-zinc-200 bg-white p-2 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                <div className="flex gap-4">
                  
                  <div className="flex min-w-[90px] flex-col items-center justify-center rounded-lg bg-green text-white p-3">

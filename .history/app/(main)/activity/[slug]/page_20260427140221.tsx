...
export default async function Page({ params }: PageProps) {
  ...
  parse(activity.description, {
    ...
    <p className="!text-lg text-center opacity-60">Вы можете ознакомиться с другими <Link href={"/activity"} className="hover:underline opacity-100">мероприятиями</Link></p>
  </>}

...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <section className='flex flex-col justify-center pb-20 px-4'>
        ...
        <div className="text-center !text-2xl mt-4 text-black !font-semibold" dangerouslySetInnerHTML={{ __html: activity.dates }} />
          </div>
        ...
        {!activity.title_bg && (
          ...
          <h1 className="text-prpl">{activity.name}</h1>
            <div className="text-center text-3xl mt-4" dangerouslySetInnerHTML={{ __html: activity.title }} />
             Дата проведения<div className="text-center !text-2xl mt-4" dangerouslySetInnerHTML={{ __html: activity.dates }} />
          </>

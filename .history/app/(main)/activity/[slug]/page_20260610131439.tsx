            ...
            <div className="rounded-3xl bg-gradient-to-r from-green to-prpl p-8 text-center text-white">
              ...
              <div className="flex flex-col md:flex-row justify-center gap-4">
                <Link
                  ...
                  className="rounded-2xl bg-white text-prpl px-8 py-4 text-lg shadow-lg hover:scale-[1.02] transition"
                >
                  Подать заявку
                </Link>
                ...
                {activity.paylink && (
                  <Link
                    ...
                    className="rounded-2xl border border-white px-8 py-4 text-lg hover:bg-white hover:text-prpl transition"
                  >
                    Оплатить участие
                  </Link>
                )}

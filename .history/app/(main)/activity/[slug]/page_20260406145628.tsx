...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <section className='flex flex-col justify-center pb-20 px-4'>
        ...
        {activity.title_bg && (
          <div className="w-full h-[450px] py-10 mb-6 rounded-md bg-cover bg-center" style={{ backgroundImage: `url(${activity.title_bg})` }}>
        ...
        <div className="text-center !text-2xl mt-4 text-prpl !font-normal" dangerouslySetInnerHTML={{ __html: activity.dates }} />
          </div>

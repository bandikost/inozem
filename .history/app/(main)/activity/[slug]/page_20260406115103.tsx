  ...
  return (
    <section className='flex flex-col justify-center pb-20 px-4'>
        <div className=" mt-27 h-full">
            ...
            <h1 className="text-prpl text-3xl text-center">{activity.name}</h1>
            <div dangerouslySetInnerHTML={{ __html: activity.title }} />
        </div>
      ...
      <div className="mb-6">
        ...
        <div dangerouslySetInnerHTML={{ __html: activity.dates }} />
      </div>
    </section>
  )
}
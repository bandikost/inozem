...
export default async function Page({ params }: PageProps) {
  ...
  return (
    ...
    <div className="container mx-auto px-2 mt-27">
     ...
     <nav className="mb-8 flex flex-wrap items-center gap-x-2 gap-y-2 text-md text-zinc-500 px-4">
  ...
  <span className="min-w-0 flex-1 truncate text-zinc-800 opacity-70" title={activity.name}>
    {activity.name}
      ...
      {activity.title_bg ? (
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl px-6 text-center">
            ...
            {activity.price > 0 && (
              <p className="my-4 sm:mt-10 text-lg text-green-300">Стоимость участия: {activity.price} ₽</p>
            )}
          </div>
        </div>
      ) : (
      ...
      <div className="max-w-6xl mx-auto mt-14">
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-6 md:p-10 shadow-sm text-lg text-default">
...
<div
dangerouslySetInnerHTML={{
__html: activity.attendance_control
}}
/>
...
<div
dangerouslySetInnerHTML={{
__html: activity.planned_results
}}
/>
...
{(activity.conditions || activity.paylink) && (
  <div className="mt-6 grid grid-cols-1 items-stretch gap-6 md:grid-cols-2">
    ...
    <div className="flex flex-col overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm">
      ...
      <div className="flex flex-1 flex-col items-start bg-gradient-to-r from-green to-prpl px-8 pt-10 text-left">

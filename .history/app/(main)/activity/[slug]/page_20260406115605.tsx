  ...
  return (
    <section className='flex flex-col justify-center pb-20 px-4'>
        <div className=" mt-27 h-full">
            ...
            <h1 className="text-prpl !text-2xl text-center">{activity.name}</h1>
            <div className="text-center text-3xl" dangerouslySetInnerHTML={{ __html: activity.title }} />
      ...
      <div className="mb-6">
        <h2 className="text-xl text-prpl mb-2">Аудитория</h2>
         <div className="text-center !text-2xl mt-4" dangerouslySetInnerHTML={{ __html: activity.audience}} />
      </div>

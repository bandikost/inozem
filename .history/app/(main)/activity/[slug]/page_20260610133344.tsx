      ...
      <div className="max-w-6xl mx-auto px-4 mt-14">
        ...
        [&_h2]:text-prpl
          ...
          [&_strong]:font-semibold
           border border-zinc-200 bg-white p-8 md:p-10 shadow-sm">
            ...
            parse(activity.description, {
              replace: (domNode) => {
                if (domNode instanceof Element) {
                  ...
                  if (domNode.name === "li") {
                    return (
                      <li className="flex gap-3 items-start !text-green [&_strong]:text-green [&_strong]:font-semibold">
                        <span className="mt-2 h-2 w-2 rounded-full bg-prpl flex-shrink-0 !text-green" />
                        <span >
                          {domToReact(
                            domNode.children as unknown as DOMNode[]
                          )}

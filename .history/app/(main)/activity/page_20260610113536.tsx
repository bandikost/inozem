        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {upcomingActivities.map(act => (
              <div
  key={act.id}
  className="group rounded-xl border border-zinc-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl"
>
  <div className="flex gap-4">
    ...
    <div className="flex flex-col justify-between">
      ...
      <Link
        ...
        className="mt-4 text-prpl font-medium hover:underline"
      >
        Подробнее →
      </Link>
    </div>

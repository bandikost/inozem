...
export default function FeedbacksCarousel({ feedback }: Props) {
  ...
  const renderCard = (feed: Feedback) => (
    <div key={feed.id} className="border border-gray-300 shadow rounded-md p-4 mt-5 grid h-full min-h-[290px] shadow-xl">
      ...
      <div className="grid grid-cols-2 w-full max-w-[480px] mt-6">
        ...
        <p className="mt-3 ">Ответ академии: df;gljdfioghdnhfgghdf;gljdfiogh dnhfgghdf;gljdfioghdnhfgghdf;gljdfioghdnhfggh</p>
      </div>

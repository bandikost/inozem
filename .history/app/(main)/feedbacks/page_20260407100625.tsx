...
<div className="grid md:grid-cols-2 gap-6 mt-10 justify-items-center">
    <div style={{ width: '460px', height: '600px', overflow: 'hidden', position: 'relative' }}>
      ...
      <div
  className={`border border-gray-300 shadow-2xl rounded-md p-4 w-[460px] relative ${
    !token ? "bg-gray-100 pointer-events-none" : ""
  }`}
>
  ...
  {!token && (
    <div className="flex flex-col items-center justify-center mt-4">
      <p className="px-6 text-gray-600 text-center">
        Вам нужно авторизироваться, чтобы оставить свой отзыв!
      </p>
      <Lock size={50} className="mt-4 text-gray-400"/>
    </div>
  )}
</div>

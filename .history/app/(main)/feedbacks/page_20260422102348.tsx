...
<div className="grid md:grid-cols-1 gap-6 mt-10 justify-items-center">
    ...
    <div className="relative w-full max-w-[480px] h-[690px] relative overflow-hidden">
      ...
      <div className="max-w-[480px] min-w-[310px]">
        ...
        <FeedbacksCarousel feedback={feedback} user={user} />
      </div>
...
<div className="grid justify-items-center rounded-md p-4 mt-10">
        ...
        {token ? (!hasUserFeedback ? ( <FeedbackForm user={user}  />
  ) : (
    <div className="flex flex-col items-center justify-center">
      <p className="mt-8 px-6 text-center">
       ({user?.isAdmin ? "." : "Вы уже оставили отзыв. Благодарим за ваше мнение!"})  
      </p>
    </div>
  )
) : (

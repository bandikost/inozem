  ...
  const renderCard = (feed: Feedback) => (
    <div key={feed.id} className="border border-gray-300 shadow rounded-md p-4 mt-5 grid h-full min-h-[290px] shadow-xl">
      ...
      <div className="grid grid-cols-2 w-full  mt-6">
        ...
        <p className="mt-3 w-[450px] text-white !font-base !text-lg border border-gray-300 px-2 py-4 rounded-md shadow-md bg-gray-100"> 
          {feed.answer === null ? `` : `Ответ академии: ${feed.answer.replace(/\n/g, " ")}`}
        </p>
      </div>

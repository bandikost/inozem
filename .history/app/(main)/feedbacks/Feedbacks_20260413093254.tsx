...
export default function FeedbacksCarousel({ feedback }: Props) {
  ...
  return (
    <div className="relative">
      ...
      <button onClick={prevSlide} className="absolute left-[-30px] top-1/2 -translate-y-1/2 mt-2 !text-black cursor-pointer border border-gray-300 px-2.5 py-1 bg-white shadow-md rounded-full hover:opacity-60">
        <span className="relative -left-0.5">◀</span>
      </button>

      <button onClick={nextSlide} className="absolute right-[-30px] top-1/2 -translate-y-1/2 mt-2 !text-black cursor-pointer border border-gray-300 px-2.5 py-1 bg-white shadow-md rounded-full hover:opacity-60">

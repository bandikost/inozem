...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="mt-15 border border-gray-300 py-4 px-6 rounded-md flex flex-col gap-4 w-[450px] shadow-2xl">
            ...
            <select required className="cursor-pointer border py-1 px-2 border-gray-300 rounded-md w-[400px] text-default text-lg" value={rate} onChange={e => setRate(e.target.value)}>
                <option>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>

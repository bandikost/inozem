               ...
               {activeItem?.links?.length > 0 && (
                  <ul className="flex gap-2 flex-col mt-5">
                    {activeItem.links.map((link, index) => (
                        ...
                        {link.url ? (
                            <a href={link.url} target="_blank" className="text-[#7C109A] underline hover:opacity-70 cursor-pointer flex items-start">
                                <Link />{link.name}
                                <hr className="border-1 text-zinc-400 w-full" />
                            </a>
                        ) : (

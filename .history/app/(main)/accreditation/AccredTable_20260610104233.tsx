    ...
    <div className="divide-y divide-gray-100">
      {filteredSchedule.map((item) => (
        ...
        >
          ...
          <div className="col-span-4 text-center text-blue-500 border-r border-gray-300 px-4  text-lg">
            {item.month} {item.day}
          </div>

          <div className="col-span-4 text-right text-blue-400 pl-4  text-lg">
            {item.time}
          </div>
        </div>
      ))}

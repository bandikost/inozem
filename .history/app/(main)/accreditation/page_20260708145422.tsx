      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="rounded-3xl bg-green px-6 py-12 md:px-12 shadow-xl mb-12">
          <div className="max-w-3xl">
            ...
            <span className="text-xl text-center">Аккредитация специалистов</span>
        </div>
        </div>



        <h1 className="text-white !text-xl sm:!text-3xl md:text-5xl font-semibold leading-tight text-center">Первичная специализированная аккредитация</h1>

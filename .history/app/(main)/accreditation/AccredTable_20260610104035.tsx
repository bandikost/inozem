  ...
  <div className="w-full max-w-4xl mt-8 rounded-xl border border-gray-200 bg-white shadow-md overflow-hidden">
    ...
    <div className="divide-y divide-gray-100">
      {filteredSchedule.map((item) => (
        ...
        >
          <div className="col-span-4 font-bold text-gray-700 border-r border-gray-300 pr-4">
            {item.stage}
          </div>

          <div className="col-span-4 text-center border-r border-gray-300 px-4 text-default">
            {item.month} {item.day}
          </div>

          <div className="col-span-4 text-right pl-4 text-default">
            {item.time}
          </div>
        </div>
      ))}

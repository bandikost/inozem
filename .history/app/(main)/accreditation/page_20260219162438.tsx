...
return (
    <section className="flex flex-col">
      <h1 className="text-[#A358B8] font-semibold mt-27 text-3xl text-center">Первичная специализированная аккредитация</h1>
        ...
        <div className="border border-[#cdd5df] border-l-[5px] border-l-blue-500 bg-[#f9fbff] px-6 py-5 rounded-xl text-slate-800 shadow-sm max-w-[900px] mx-auto my-10 leading-relaxed">
            <p className="mb-2 font-semibold">Итоги прохождения первичной специализированной аккредитации:</p>
            <p className="mt-4"> Оценка результатов прохождения этапов аккредитации специалиста оформляется протоколами заседаний аккредитационной подкомиссии, подписываемыми в день завершения соответствующего этапа и размещаемыми не позднее двух рабочих дней со дня их подписания на официальном сайте и информационных стендах аккредитационного центра.</p>
            <p className="mt-4"> Сведения о лицах, признанных прошедшими аккредитацию специалиста, вносятся Министерством здравоохранения Российской Федерации в единую государственную информационную систему в сфере здравоохранения в рамках ведения персонифицированного учета в соответствии со статьями 92, 93 и 93.1 Федерального закона №323-ФЗ.</p>
        </div>

        <p className="mt-4 text-sm">Первичная специализированная аккредитация (ПСА)– это процедура оценки профессиональных навыков фармацевтических или медицинских работников. Ее проходят выпускники интернатуры, ординатуры, а также врачи и специалисты со средним профессиональным образованием после завершения дополнительного профессионального образования по программам профессиональной переподготовки.</p>

    ...
    <div className="divide-y divide-gray-100">
      {filteredSchedule.map((item) => (
        ...
        >
          ...
          <div className="col-span-4 text-center !text-teal-700 border-r border-gray-300 px-4  text-lg">
            {item.month} {item.day} {item.year}<span className="!text-gray-700 text-sm !font-semibold"> г.</span> 
          </div>

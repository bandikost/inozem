...
const items = [
  ...
  { id: 2, title: "Документы для первичной специализированной аккредитации", text: "Текст про документы..." },
  { id: 3, title: "Правила поведения аккредитаци", text: "Текст про правила..." },
]
        ...
        <div className="flex justify-between">
          ...
          {items.map(item => (
            <button
              ...
              className={`px-2 py-2 text-white rounded-md cursor-pointer transition ${activeId === item.id ? "bg-purple-600" : "bg-prpl hover:bg-purple-500"}`}>
              {item.title}
            </button>
          ))}
        </div> 

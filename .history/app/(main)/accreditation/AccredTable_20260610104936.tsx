    ...
    <div className="divide-y divide-gray-100">
      {filteredSchedule.map((item) => (
        ...
        >
          ...
          <div className="col-span-4 text-center text-gray-800 border-r border-gray-300 px-4  text-lg">
            <span className="!text-teal-700">{item.month} </span>
            <span className="!text-teal-700">{item.day}</span> 
            <span className="!text-teal-700"> {item.year}</span> г.
          </div>

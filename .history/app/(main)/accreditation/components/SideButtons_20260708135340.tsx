        ...
        {activeItem.links?.map((link, index) => (
            ...
            <div key={index} className="flex">
                ...
                {link.url && (
                    ...
                    <a href={link.url} target="_blank" className="group flex items-center justify-between
                        w-full
                        rounded-2xl
                        border
                        border-zinc-200
                        px-5
                        py-4
                        text-lg text-zinc-800 transition-all
                        hover:border-blue
                        hover:shadow-md
                        "
                    >
                        ...
                        <ArrowUpRight size={22} className="shrink-0 text-zinc-400 group-hover:text-blue transition"/>

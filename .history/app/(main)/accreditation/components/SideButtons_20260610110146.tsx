               ...
               {activeItem?.links?.length > 0 && (
                  <ul className="flex gap-2 flex-col mt-5">
                    {activeItem.links.map((link, index) => (
                        ...
                        {link.url ? (
                            <a href={link.url} target="_blank" className="text-[#7C109A] underline hover:opacity-70 cursor-pointer flex flex-col items-center text-left !text-lg">
                            ...
                            <p className="text-zinc-800 text-base !text-lg" >
                            {index + 1}. {link.name}
                            </p>
                        )}
                        </li>

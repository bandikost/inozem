...
,
  ...
  { id: 2, title: "Документы для первичной специализированной аккредитации",
    links: [
        ...
        { title2: "В случае дистанционной подачи документов необходимо прислать на адрес электронной почты accred.inozem.online@yandex.ru скан-копии документов (в хорошем качестве с читаемыми реквизитами документа):", name: "Заявление о допуске к аккредитации специалиста" },
        { name: "Копия сертификата специалиста (при наличии)" },
        { name: "Копия сертификата специалиста (при наличии)" },
        { name: "Копия сертификата специалиста (при наличии)" },
    ]},

...
export default function Page() {
   ...
   const sortedItems = [...items].sort((a, b) => {
    if (sortType === 'asc') {
      ...
      return b.name.localeCompare(a.text)
    }
  });
      ...
      <h1 className="text-prpl font-semibold mt-27 text-3xl text-center">Первичная специализированная аккредитация</h1>
        ...
        <div className="flex justify-between">
            ...
            <div className="flex flex-col mt-8 mr-4 gap-4">
                <button onClick={toggleSort} className="px-2 py-2 bg-prpl text-white text-center rounded-md cursor-pointer hover:bg-purple-500">Нормативная база аккредитации</button>

  ...
  return (
    <div className="mt-8 rounded-2xl border border-gray-200 bg-gray-50/50 p-5">
          ...
          >
            ...
            <div className="flex items-center justify-between gap-4 border-b border-gray-100 bg-white px-5 py-4">
              ...
              <button
                ...
                className="cursor-pointer hover:opacity-80 rounded-lg px-3 py-2 text-sm text-red-500 transition hover:bg-red-50"
              >
                Удалить группу
              </button>
            ...
            <div className="p-5">
                    ...
                    >
                      ...
                      <div className="mb-3 flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="cursor-pointer hover:opacity-80 text-xs font-medium text-red-500 transition hover:text-red-700"
                        >
                          Удалить
                        </button>
              ...
              <button
                ...
                className="cursor-pointer hover:opacity-80  mt-4 inline-flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-600 shadow-sm transition hover:border-blue hover:text-blue"
              >
                + Добавить ссылку
              </button>
      ...
      <button
        type="button"
        onClick={addGroup}
        className="cursor-pointer hover:opacity-80 mt-6 inline-flex items-center rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-semibold text-gray-700 shadow-sm transition hover:border-blue hover:text-blue"
      >

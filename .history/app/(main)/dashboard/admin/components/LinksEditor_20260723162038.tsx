...
export default function LinksEditor({
  ...
  const removeItem = (
    ...
    copy[groupIndex] = {
      ...copy[groupIndex],
      items: copy[groupIndex].items.filter(
        (_, i) => i !== itemIndex
      ),
    }
      ...
      <div className="flex flex-col gap-5">
        ...
        {links.map((group, groupIndex) => (
          ...
          <div
            ...
            draggable
            onDragStart={(event) =>
              handleDragStart(event, groupIndex)
            }
            onDragOver={(event) =>
              handleDragOver(event, groupIndex)
            }
            onDrop={(event) =>

    ...
    <div className="mx-auto mt-12 flex w-full max-w-6xl flex-col gap-6 pb-24">
            ...
            <div className="flex flex-col gap-4 border-b border-gray-100 bg-gray-50/70 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-red-100 bg-red-50 px-3 py-2 text-sm text-red-600 transition hover:bg-red-100"
                >
                  <Trash2 size={16} />
                  Удалить
                </button>
      ...
      <div className="flex justify-end border-t border-gray-200 pt-6">
        <button
          type="button"
          onClick={save}
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue px-5 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue/20 transition hover:opacity-90 sm:w-auto"
        >
          <Save size={17} />
          Сохранить изменения
        </button>

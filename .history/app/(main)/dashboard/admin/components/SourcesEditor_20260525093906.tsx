...
export default function SourcesEditor({
  ...
  const addSubtitle = (videoIndex: number) => {

    const copy = [...sources];

    copy[videoIndex].subtitles.push("");
        ...
        {sources.map((video, index) => (
          ...
          >
            ...
            <input
              ...
              value={video.src}
              onChange={(e) =>
                updateVideo(index, "src", e.target.value)
              }
            ...
            <input
              ...
              value={video.preview}
              onChange={(e) =>
                updateVideo(index, "preview", e.target.value)
              }
              className="border p-2 rounded-md"
            />

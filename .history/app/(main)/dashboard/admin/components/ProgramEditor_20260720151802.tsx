    ...
    <div className="mx-auto mt-12 flex w-full max-w-6xl flex-col gap-6 pb-24">
      ...
      <div className="flex flex-col gap-5 rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_10px_35px_rgba(0,0,0,0.04)] md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            type="button"
            onClick={addBlock}
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 transition hover:border-blue hover:text-blue"
          >
            <Plus size={17} />
            Добавить блок
          </button>
          ...
          <button
            type="button"
            onClick={save}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-blue/20 transition hover:opacity-90"
          >
            <Save size={17} />
            Сохранить
          </button>
      ...
      <div className="flex items-end justify-between gap-4">
        ...
        <button
          type="button"
          onClick={addBlock}
          className="hidden items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:border-blue hover:text-blue sm:flex"
        >
          <Plus size={16} />
          Добавить блок
        </button>
        ...
        {program.blocks.length === 0 && (
          <div className="rounded-3xl border border-dashed border-gray-300 bg-gray-50 px-6 py-14 text-center">
            ...
            <button
              type="button"
              onClick={addBlock}
              className="mt-5 inline-flex items-center gap-2 rounded-xl bg-blue px-4 py-3 text-sm font-medium text-white transition hover:opacity-90"
            >
              <Plus size={16} />

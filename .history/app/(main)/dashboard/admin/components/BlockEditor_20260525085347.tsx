  ...
  return (
    <div className="border p-4 m-2">
      ...
      <input
        ...
        className="border border-gray-300 p-2 mb-2 mr-2 rounded-md"
      />
      ...
      >
        <option value="main">Видео без ссылок</option>
        <option value="second">Ссылки/Текст</option>
        <option value="four">Видео + ссылки</option>
      </select>

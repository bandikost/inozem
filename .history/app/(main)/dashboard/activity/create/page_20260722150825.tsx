      ...
      >
        ...
        <section className="border-b border-gray-100 bg-gray-50/50 p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="border p-6 border-gray-300 shadow-md text-lg rounded-2xl flex bg-blue-100">
                <p>Изображения находятся</p>
                <Link href="" className="ml-2 cursor-pointer hover:opacity-70">- На облаке академии</Link> 
            </div>

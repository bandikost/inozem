        ...
        <section className="border-b border-gray-100 bg-gray-50/50 p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="border p-6 border-gray-300 shadow-md text-lg rounded-2xl flex bg-yellow-100">
                ...
                <Link target="_" href="https://console.yandex.cloud/folders/b1gjd5dnmt6jjindolec/storage/buckets/inozemstorage?key=teachers%2F&versionsDisplay=false" className="ml-2 cursor-pointer hover:opacity-70">- На облаке академии</Link> 
            </div>

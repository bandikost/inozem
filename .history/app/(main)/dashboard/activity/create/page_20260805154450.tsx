          ...
          <div className="space-y-6">
            ...
            <Field label="Цель мероприятия">
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                placeholder="Опишите цель образовательного мероприятия..."
                className="input-main min-h-[140px] resize-y"
              />
            </Field>
            ...
            <Field label="Контроль присутствия">
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                placeholder="Опишите порядок контроля присутствия участников..."
                className="input-main min-h-[140px] resize-y"
              />
            </Field>
            ...
            <Field label="Планируемые результаты">
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                placeholder="Опишите результаты, которые получит участник..."
                className="input-main min-h-[140px] resize-y"
              />
            </Field>

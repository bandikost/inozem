...
export default async function CreateActivityPage({ params }: ProgramsPageProps) {
    ...
    <div className="min-h-screen py-12 px-4 mt-16">
      <div className="mx-auto max-w-5xl space-y-8">
        <nav className="mb-8 flex flex-wrap items-center gap-x-2 gap-y-2 text-md text-zinc-500">
            ...
            <LoadingLink href="/manager" className="shrink-0 hover:text-blue transition hover:underline">

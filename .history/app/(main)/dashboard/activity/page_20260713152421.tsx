  ...
  return (
    <section className="mx-auto mt-20 max-w-7xl px-6 pb-16">
      ...
      <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
        ...
        <LoadingLink
          href="/dashboard/manager/activity/create"
          className="
            inline-flex
            items-center
            gap-2
      ...
      <div className="grid gap-5">
        ...
        {activity.map((item) => (
          <LoadingLink
            key={item.id}
            href={`/dashboard/manager/activity/${item.slug}`}
            className="
              group
              rounded-3xl
              border
          ...
          >
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="min-w-0">
                ...
                <h2 className="truncate text-2xl break-words font-bold">
                  {item.name}
                </h2>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  <div className="inline-flex items-center gap-2 rounded-xl bg-zinc-100 px-3 py-2 text-sm">
                    <CalendarDays size={16} />
                    {item.dates || "Дата не указана"}
                  </div>

                  <div className="rounded-xl bg-zinc-100 px-3 py-2 text-sm">
                    {item.year ?? "Без года"}
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="rounded-2xl bg-zinc-100 p-3 transition group-hover:bg-black group-hover:text-white">
                  <Pencil size={20} />
                </div>

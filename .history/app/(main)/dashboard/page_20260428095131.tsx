...
export default function Page() {
  ...
  return (
    ...
    <div className="flex flex-col items-center min-w-[310px] mx-auto">
      ...
      <p className="mt-4">Вернуться в <Link href="/profile" className="hover:underline text-lg">профиль</Link></p>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-10 border border-zinc-400 rounded-xl p-4 shadow-2xl w-full max-w-[450px]">
        <input

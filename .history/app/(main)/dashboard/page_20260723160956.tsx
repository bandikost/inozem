...
export default function Page() {
  ...
  <div className="w-full max-w-md flex flex-col items-center">
    ...
    >
      <input
        className="mt-4 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-default outline-none
      ...
      <input
        className="w-full rounded-lg border border-zinc-300 bg-white px-3 py-2 text-base outline-none
                   focus:border-prpl focus:ring-2 focus:ring-prpl/20 transition text-lg !font-normal"
        type="password"
        placeholder="Пароль"
        value={password}

...
res.json()
    ...
    return (
      ...
      <input placeholder="Название" value={name} onChange={e => setName(e.target.value)} className="!text-xl border border-gray-400 p-2 rounded mt-2" />
      ...
      <input placeholder="Slug для URL" value={slug} onChange={e => setSlug(e.target.value)} className="!text-xl border border-gray-400 p-2 rounded " />
      <button type="submit" className="button-more mt-4 w-full">Добавить программу</button>
    </form>
        </section>
    )
}
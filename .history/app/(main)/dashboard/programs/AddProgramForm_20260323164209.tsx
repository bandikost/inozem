...
const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
        <section className="flex flex-col items-center mt-20 relative">
      {loading && (
        <div className="fixed inset-0 bg-zinc-400 bg-opacity-70 flex justify-center items-center z-[9999]">

      ...
      >
        ...
        <div className="border-b border-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="flex items-end">
              ...
              <label className="flex w-full cursor-pointer items-center justify-between rounded-xl border border-gray-200 bg-white px-5 py-4 transition hover:border-blue-300">
        ...
        <div className="flex items-center justify-between gap-6 bg-white px-8 py-6">
          ...
          <p className="hidden text-sm text-gray-500 md:block">
            После создания программу можно будет дополнить материалами и
            документами.
          </p>

  ...
  return (
    ...
    <div className="flex flex-col items-center min-w-[310px] mx-auto">
      ...
      <form
        ...
        className="flex flex-col gap-4 mt-10 border border-zinc-400 rounded-xl p-4 shadow-2xl"
      >
        <input
          className="border border-zinc-400 p-1.5 rounded max-w-[450px]"
          type="text"
          placeholder="Логин"
          value={email}
        ...
        <button
          disabled={loading}
          className="px-4 py-2 bg-prpl text-white rounded"
        >

...
export default function ProgramAdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-10 mb-10 border-gray-300">

      <div className="max-w-7xl mx-auto">

        <div className="flex justify-between items-center mb-10 border ">
                    ...
                    <div className="grid gap-4">
                      ...
                      <div className="flex justify-end mb-4">
                        <button
                            ...
                            className="!bg-red-400 border border-red-300 px-3 py-1 rounded-xl cursor-pointer hover:opacity-80">
                            Удалить блок
                        </button>
                        </div>
                      ...
                      <div className="mt-10">
                        ...
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <button
                            ...
                            className="bg-black text-white px-4 py-2 rounded-xl hover:opacity-80 curso  r-pointer"
                          >
                            Добавить ссылки
                          </button>

  ...
  return (
      <section className="flex flex-col items-center mt-30">
        ...
        <div className="grid grid-cols-2 gap-8 items-center justify-center mt-10">
            <Link href={"/dashboard/users"} className="text-blue border border-gray-300 mt-8 rounded shadow-2xl bg-white px-6 py-3 hover:opacity-70">Выдача кабинета пользователю</Link>
            <Link href={"/dashboard/users"} className="text-blue border border-gray-300 mt-8 rounded shadow-2xl bg-white px-6 py-3 hover:opacity-70">Выдача кабинета пользователю</Link>
        </div>
      </section>
  )

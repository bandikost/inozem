...
export default async function ManagerPage() {
  ...
  return (
      <section className="flex flex-col items-center mt-30">
        <h1 className="text-prpl">Админ</h1>
        <div className="grid grid-cols-2 gap-8 items-center justify-center mt-10">
            ...
            <Link href={"/dashboard/programs"} className="text-lg text-blue border border-gray-300 mt-8 rounded shadow-2xl bg-white px-6 py-3 hover:opacity-70 hover:underline">
                Программы оубчения
            </Link>

            <Link href={"/dashboard/content"} className="text-lg text-blue border border-gray-300 mt-8 rounded shadow-2xl bg-white px-6 py-3 hover:opacity-70 hover:underline">
                Наполнение/Редактирование программ обучения
            </Link>
        </div>
      </section>
  )

...
import { getTestsCreated, getTestsCreatedBySlug } from "@/lib/tests_creator/tests"
...
export default async function Page({ params }: PageProps) {
  ...
  return (
    <section className="flex flex-col mt-27 px-6">
      ...
      <LoadingLink href="/dashboard/test_creator/create" className="inline-flex rounded-xl bg-prpl px-6 py-3 !text-white transition hover:opacity-90">
  + Создать тест
</LoadingLink>

...
export default function UsersClient({ users, programs }: UsersClientProps) {
  ...
  const [selectedProgram, setSelectedProgram] = useState<Record<number, number>>({})
        ...
        <div className='flex justify-between items-center'>
            ...
            <form className='flex flex-col '>
              <div className="flex flex-col">
                ...
                <select className='border border-gray-400 rounded p-1 mb-2 max-w-[220px] w-full truncate rounded'
                  value={selectedProgram ?? ''} onChange={e => setSelectedProgram(Number(e.target.value))}>

    ...
    <section className="flex flex-col items-center ">
      <div className="flex items-center mt-12">
        ...
        <button
          ...
          className="px-4 py-2 bg-purple-600 text-white rounded flex cursor-pointer hover:bg-prpl ml-2"
        >
      ...
      <div className="border-2 border-dotted border-zinc-300 pb-8 mt-8 rounded shadow-2xl bg-white w-full">
        <div className="grid gap-8 mt-6 px-6">
          {processedUsers.map((user, idx) => (
            <div key={user.id}>
                ...
                <button className='px-2 py-2 bg-purple-600 text-white rounded text-center ml-12 cursor-pointer hover:bg-prpl'>добавить в программу</button>

                </div>
                <hr className='mt-2 text-zinc-500' />
            </div>
          ))}

...
>
  ...
  {/* Градиент — не блокирует клики по карте */}
  <div
    className="
      pointer-events-none
      absolute
  ...
  >
    ...
    {/* Сама карточка снова принимает клики */}
    <div
      className="
        pointer-events-auto
        bg-white/95
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="p-3 rounded-2xl bg-prpl/10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mt-10">
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
            ...
            <div className="mt-8 space-y-4">
              ...
              <ToggleBlock title="Вакантные места для приема (перевода) обучающихся">
                <p>Не предусмотрено</p>
              </ToggleBlock>

              <ToggleBlock title="Организация питания в образовательной организации">
                <p>Не предусмотрено</p>
              </ToggleBlock>

    ...
    <section className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-24">
       <nav className="mb-6 flex items-center gap-2 text-sm text-zinc-500">
        <LoadingLink href="/" className="hover:text-blue transition !font-normal text-md hover:opacity-70 hover:underline">
          Главная
        </LoadingLink>

        <ChevronRight size={14} />

        <span className="text-zinc-800 opacity-60 !font-normal text-md">
          О Нас
        </span>
      </nav>

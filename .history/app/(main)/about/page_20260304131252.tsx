  ...
  return (
    <div className="px-4">
      <button
        ...
        className="!text-prpl cursor-pointer hover:underline ">
        {title} ({open ? "Свернуть" : "Показать"})
      </button>
      {open && <div className="px-6 mt-2 !text-prpl grid gap-2 mt-4">{children}</div>}
    </div>
  )
}
    ...
    <section className="flex flex-col px-4">
      ...
      <div className="grid grid-cols-1 tablet:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col mt-8">
          ...
          <div className="border border-gray-300 pb-4 mt-8 rounded shadow-2xl bg-white px-6 py-8 grid gap-4 ">
      ...
      <div className="border border-gray-300 my-8 rounded shadow-2xl bg-white px-6 py-3">
        ...
        <ul className="grid gap-6 grid-cols-6 mt-4 text-md">
          <a href="https://video.organum-visus.ru/" target="_blank"><img className="object-fit" width={60} height={60} src="/images/site/ovis.png" /></a>
								...
								<a href="https://spbmrc.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/news/1583854926MRC.png"  alt="" loading="lazy" /></a>
								
								<a href="https://www.sogaz-clinic.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/sogaz.png"/></a>
								<a href="http://loposm.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/passd.jpg" alt="" loading="lazy" /></a>
								<a href="https://rusal.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/Русал.png" alt="" loading="lazy" /></a>
								<a href="https://efamedica.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/efa-medica.png" alt="" loading="lazy" /></a>
								<a href="https://www.medison.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/npm/2025/img/медиэйс.webp" alt="" loading="lazy" /></a>
								<a href="https://www.jnjmedicaldevices.com/en-US/companies/ethicon" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/ethicon.png" alt="" loading="lazy" /></a>
								<a href="https://www.lintex.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/lintex.png" alt="" loading="lazy"/></a>
								<a href="https://spb-maneken.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/medtech.png" alt="" loading="lazy"/></a>
								<a href="https://medsestre.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/rams.png" alt="" loading="lazy"/></a>
								<a href="https://2440202.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/solt.png" alt="" loading="lazy"/></a>
								<a href="https://www.karlstorz.com/ru/ru/index.htm" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/storz.png" alt="" loading="lazy" /></a>
								<a href="https://xn--b1aecboaym3f.xn--p1ai/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/vmedrf.png" alt="" loading="lazy" /></a>
								<a href="http://www.vodokanal.spb.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/vodokanal.png" alt="" loading="lazy" /></a>
								<a href="https://medsyst.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/medsyst.jpeg" alt="" loading="lazy" /></a>
								<a href="http://fondendomir.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/endomir.webp" alt="" loading="lazy" /></a>
								<a href="https://www.martinex.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="/images/site/MARTINEX_LOGO MT.png" alt="" loading="lazy" /></a>
								<a href="http://medcomtech.ru/" target="_blank"><img className="object-fit" width={60} height={60}src="http://www.medcomtech.ru/img/elements/verh_.png"  alt="" loading="lazy"/></a>
        </ul>
      </div>

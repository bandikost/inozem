...
export default function Page() {
  return (
    <section className="flex flex-col px-4 py-10 bg-gradient-to-b from-slate-50 to-white min-h-screen">
     <div className="text-center mt-24 mb-12">
      <span className="inline-flex px-4 py-2 rounded-full bg-prpl/10 text-prpl text-sm font-medium">
      ...
      <p className="max-w-3xl mx-auto mt-4 text-lg text-slate-600">
        Более 15 лет обучаем медицинских специалистов по всей России
      </p>
    </div>
      ...
      <div className="rounded-3xl
        ...
        hover:shadow-xl
        transition-all
        duration-300  mt-8 rounded shadow-2xl bg-white px-6 py-3">

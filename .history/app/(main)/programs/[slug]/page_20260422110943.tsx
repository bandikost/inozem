    ...
    <section className="prose mx-auto px-6 mt-27">
      ...
      {!hasAccess ? ( 
        ...
        <p className="mt-2"><strong className="text-blue">Направления:</strong> {program.specialization}</p>
          <div className="grid grid-cols-2 gap-6 mb-15 mt-10">

          <div className="h-full program-description border border-gray-300 rounded-md shadow-2xl p-4" dangerouslySetInnerHTML={{ __html: program.description }}/>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col justify-between items-start border border-gray-300 rounded-md shadow-2xl p-4">
              ...
              <div className="flex justify-between w-full">
                ...
                <Link className="button-more mt-2" href={"/contacts"}>Перейти в контакты</Link>
              </div>

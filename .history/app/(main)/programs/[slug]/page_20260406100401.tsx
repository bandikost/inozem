...
if (token) {
  ...
  <div className="mt-6 h-full program-description border border-gray-300 rounded-md shadow-2xl p-4"
       dangerouslySetInnerHTML={{ __html: program.description }}
  />

  <time className="mt-4 h-full flex flex-col items-start border border-gray-300 rounded-md shadow-2xl p-4">

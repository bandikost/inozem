    ...
    <section className="prose mx-auto px-6 mt-27 mb-10">
      ...
      {!hasAccess ? ( 
        ...
        <>
          ...
          {program.time >= 288 && program.education === "Высшее"  && program.category === "pp" ? <div className="mt-20 border border-gray-300 rounded-md shadow-2xl"><h3>Ожидаются видео</h3></div> : ""}
          <div className="mt-20 border border-gray-300 rounded-md shadow-2xl">
            <h3>Текст</h3>
          </div>
         ...
         {program.category === "pp" && <div className="mt-20 border border-gray-300 rounded-md shadow-2xl">
            <h3>Тест</h3>
          </div> }
        </> 

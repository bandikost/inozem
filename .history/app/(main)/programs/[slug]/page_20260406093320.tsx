      ...
      {!hasAccess ? ( 
        ...
        <ul className="space-y-1 text-base grid">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col items-start border border-gray-300 rounded-md shadow-2xl">
            ...
            <div className="flex flex-col items-start border border-gray-300 rounded-md shadow-2xl px-4 py-3">

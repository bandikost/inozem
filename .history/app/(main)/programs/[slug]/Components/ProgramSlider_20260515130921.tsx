  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6 gap-4">
        <button onClick={prevSlide} className="px-4 py-2 rounded-md !text-blue-600 !text-lg hover:opacity-80 hover:underline">
          <span className='flex items-center gap-2'><ArrowLeft size={16}/> Назад</span>
        </button>

        <button onClick={nextSlide} className="border px-4 py-2 rounded-md button-more">
          Следующий блок
        </button>
      </div>

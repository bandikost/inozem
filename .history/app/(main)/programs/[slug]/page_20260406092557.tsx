...
if (token) {
  ...
  return (
    <section className="prose mx-auto px-6 mt-27">
      ...
      Подайте заявку на обучение, если у вас появились/остались вопросы, и наши сотрудники ответят вам в ближайшее время! <Link className="button-more " href={"/bid"}>Подать заявку</Link>

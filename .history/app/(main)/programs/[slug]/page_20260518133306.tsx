...
export default async function Page({ params }: ProgramsPageProps) {
  ...
  blocks.push({
    ...
    component: currentTitle?.blocks[0] === "" ? "" : <BaseVideo education={education} category={category} /> ,
  })
   
  blocks.push({
    title: currentTitle?.blocks[1],
    component: currentTitle?.blocks[1] === "" ? "" : <Main specialization={specialization} category={category} />,
  })

  blocks.push({
    title: currentTitle?.blocks[2] || "",
    component:  currentTitle?.blocks[2] === "" ? "" : <Second specialization={specialization} category={category} />,
  })

  blocks.push({
    title: currentTitle?.blocks[3] || "",
    component: currentTitle?.blocks[3] === "" ? "" : <Three specialization={specialization} category={category} />,
  })

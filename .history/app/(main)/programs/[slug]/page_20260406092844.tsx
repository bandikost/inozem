  ...
  return (
    <section className="prose mx-auto px-6 mt-27">
      ...
      <div className="flex flex-col items-start">
        ...
        <h3 className="my-8">Если вы решили, что программа вам подходит - вы можете самостоятельно оплатить ее и получить доступ в ближайший старт начала программы</h3>

    ...
    <section className="prose mx-auto px-6 mt-27">
      ...
      {!hasAccess ? ( 
        ...
        <p className="mt-2"><strong className="text-blue">Направления:</strong> {program.specialization}</p>
          <div className="grid grid-cols-2 items-center gap-6 my-10 h-full">

            <div className="mt-6 program-description border border-gray-300 rounded-md shadow-2xl p-4 " dangerouslySetInnerHTML={{ __html: program.description }}/>

            <time className="mt-4 flex flex-col items-start border border-gray-300 rounded-md shadow-2xl p-4 ">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex flex-col justify-between items-start border border-gray-300 rounded-md shadow-2xl p-4">
              <h3>Подайте заявку на обучение, если у вас появились/остались вопросы, и наши сотрудники ответят вам в ближайшее время!</h3> 
              <Link className="button-more mt-2" href={"/bid"}>Подать заявку на обучение</Link>
            </div>

    ...
    <section className="prose mx-auto px-6 mt-27">
      ...
      {!hasAccess ? ( 
        ...
        <p className="mt-2"><strong className="text-blue">Направления:</strong> {program.specialization}</p>
          <div className="grid grid-cols-2 gap-6 rounded-md shadow-2xl p-4 mb-10">

            <div className="mt-6 program-description border border-gray-300" dangerouslySetInnerHTML={{ __html: program.description }}/>

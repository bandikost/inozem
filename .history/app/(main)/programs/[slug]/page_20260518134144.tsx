...
const blocks = [
  {
    ...
    component: currentTitle?.blocks[0] ? <BaseVideo education={education} category={category} /> : null,
  },
  {
    title: currentTitle?.blocks[1],
    component: currentTitle?.blocks[1] ? <Main specialization={specialization} category={category} /> : null,
  },
  {

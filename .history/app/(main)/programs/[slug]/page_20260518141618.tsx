...
export default async function Page({ params }: ProgramsPageProps) {
  ...
  const currentSpecialization = title.find((item) => headlines.startsWith(item.specialization) === program.specialization)
...
const blocks = [
  ...
  },
  {
    ...
    component: currentTitle?.blocks[1] ? <Main education={education} specialization={specialization} category={category} /> : null,
    headline: currentTitle?.headlines
  },
  {
    title: currentTitle?.blocks[2] || "",
    component:  currentTitle?.blocks[2] ? <Second specialization={specialization} category={category} /> : null,
  },
  {
    title: currentTitle?.blocks[3] || "",
    component: currentTitle?.blocks[3] ? <Three specialization={specialization} category={category} /> : null,
  },
  {

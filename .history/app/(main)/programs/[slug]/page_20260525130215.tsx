...
const blocks: ProgramSliderBlock[] =
  currentBlocks.map((block: any): ProgramSliderBlock | null => {
          return {
            title: block.title,
            component: <Main sources={block.data.sources} links={block.data.links}/> 
          }
    }).filter((b: any): b is ProgramSliderBlock => b !== null)

  ...
  return (
    <section className="prose mx-auto px-3 mt-27 mb-10">
      ...
      {!hasAccess ? ( 
        ...
        <>
        {user?.isAdmin && <Link href="/dashboard/admin/" className="rounded-md shadow border border-gray-500 bg-gray-300 !text-white p-2 hover:opacity-80 cursor-pointer">Редактировать</Link>}

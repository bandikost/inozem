...
const blocks = [
  ...
  // Лекции
  {
    ...
    component: currentTitle?.blocks[1] ? <Main education={education} category={category} headline={currentTitle?.headlines ?? []}/> : null,
  },
    ...
    <section className="prose mx-auto px-6 mt-27 mb-10">
      ...
      {!hasAccess ? ( 
        ...
        <>
         ...
         <ProgramSlider themes={themes} blocks={blocks} />

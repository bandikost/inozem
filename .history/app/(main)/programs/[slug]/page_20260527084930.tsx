  ...
  return (
    <section className="prose mx-auto px-3 mt-27 mb-10">
      ...
      {!hasAccess ? ( 
        ...
        <>
        {user?.isAdmin && <Link href="/dashboard/admin/" className="fixed top-10 left-0 rounded-md shadow border border-gray-500 bg-gray-300 !text-white p-2 cursor-pointer">Редактировать</Link>}

  ...
  return (
    <section className="prose mx-auto px-6 mt-27">
      ...
      <div className="flex flex-col items-start">
        <p>Подайте заявку на обучение, если у вас появились/остались вопросы, и наши сотрудники ответят вам в ближайшее время!</p> 
        <Link className="button-more " href={"/bid"}>Подать заявку</Link>
      </div>

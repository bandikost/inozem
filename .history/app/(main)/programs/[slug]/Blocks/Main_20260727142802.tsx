                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    {group.items.map((link) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-4 py-4 text-base text-slate-800 shadow-sm transition-all hover:-translate-y-0.5 hover:border-violet-300 hover:shadow-md md:text-lg"
                      >

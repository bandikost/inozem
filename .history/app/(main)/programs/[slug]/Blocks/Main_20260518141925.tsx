...
export default function Main({category, specialization, education, headline} : Props) {
    ...
    <section className="relative">
            ...
            <div className="border border-gray-300 rounded-md shadow-2xl p-6">
                ...
                <div className="mt-10">
                  <h4 className="!text-2xl text-prpl">{headline} Постеры Национального совета по реанимации</h4>

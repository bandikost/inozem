...
export default function Main({category, specialization} : Props) {
    ...
    <section className="relative">
            ...
            <div className="border border-gray-300 rounded-md shadow-2xl p-6">
                ...
                {specialization === "Сестринское дело" && category === "Профессиональная переподготовка" && <PrimaryMedicalVideo />}

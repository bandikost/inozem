...
return (
    <section className='flex flex-col justify-center pb-20 px-4'>
        ...
        <div className="grid items-center justify-center grid-cols-1 md:grid-cols-2 gap-8 ">

            <div className="border border-gray-300 mt-8 rounded shadow-2xl bg-white pb-6 max-w-[400px] mx-auto md:max-w-[600px]">   
            ...
            <div className='border border-gray-300 px-6 mt-8  rounded shadow-2xl bg-white'>

    ...
    return (
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            <div className="grid">
                <ImageGallery images={["https://storage.yandexcloud.net/inozemstorage/simcenter/1.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/2.png"]} cols="grid-cols-4">
                    <div>
                        <div>1</div>
                        <div>1</div>
                    </div>

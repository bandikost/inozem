       ...
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            <h2 className="text-prpl py-2">В СТЦ Академии воспроизведен кабинет манипуляционная, оснащенный следующим оборудованием</h2>
                <ImageGallery images={["https://storage.yandexcloud.net/inozemstorage/simcenter/7.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/8.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/9.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/10.png",
                 "https://storage.yandexcloud.net/inozemstorage/simcenter/11.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/12.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/13.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/14.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/15.png"
                ]} cols="grid-cols-5"/>
        </div>
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            <div className="grid">
                <ImageGallery images={["https://storage.yandexcloud.net/inozemstorage/simcenter/1.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/2.png"]} cols="grid-cols-2" />
         ...
         <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            ...
            <p className="!font-normal">В СТЦ Академии работает симуляционная родовая, в которой проходят обучение как врачи акушеры-гинекологи, так и акушерки.
                ...
                <ImageGallery images={["https://storage.yandexcloud.net/inozemstorage/simcenter/3.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/4.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/5.png", "https://storage.yandexcloud.net/inozemstorage/simcenter/6.png"]} cols="grid-cols-4" />
        </div>

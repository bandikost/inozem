       ...
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            <div className="flex justify-center">
                <ImageGallery images={["/Images/simcenter/1.png", "/Images/simcenter/2.png"]} cols="grid-cols-2" />
            </div>
         ...
         <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            ...
            <p className="!font-normal">В СТЦ Академии работает симуляционная родовая, в которой проходят обучение как врачи акушеры-гинекологи, так и акушерки.
                ...
                <ImageGallery images={["/Images/simcenter/3.png", "/Images/simcenter/4.png", "/Images/simcenter/5.png", "/Images/simcenter/6.png"]}/>
        </div>

        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            <h2 className="text-prpl py-2">Акушерство и гинекология и Акушерское дело</h2>
            <p className="!font-normal">В СТЦ Академии воспроизведен кабинет манипуляционная, оснащенный следующим оборудованием:
                <br/>
                Оборудование для симуляционно-тренингового обучения по направлениям подготовки «Акушерство и гинекология» и «Акушерское дело»</p>
                <ImageGallery images={["/Images/simcenter/7.png", "/Images/simcenter/8.png", "/Images/simcenter/9.png", "/Images/simcenter/10.png",
                 "/Images/simcenter/11.png", "/Images/simcenter/12.png", "/Images/simcenter/13.png", "/Images/simcenter/14.png", "/Images/simcenter/15.png"
                ]} cols="grid-cols-5"/>
        </div>

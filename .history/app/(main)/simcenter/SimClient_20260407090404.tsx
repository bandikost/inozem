       ...
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            items={[
                ...
                { type: "video", src: "https://rutube.ru/play/embed/75a6452524e2ed9ac387a654c208b57e", preview: "/Images/заглушка.png" },            
                { type: "video", src: "https://rutube.ru/play/embed/35c0a78073eac3c019deec0d4469d2d7", preview: "/Images/заглушка.png" },
            ]}
            />

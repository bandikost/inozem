...
export default function Page() {
    ...
    return (
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-3">
            <h2 className="text-prpl mt-8">Большим успехом услуги СТЦ пользуются при подготовке специалистов к первичной специализированной аккредитации (ПСА) по направлениям подготовки</h2>
        </div>

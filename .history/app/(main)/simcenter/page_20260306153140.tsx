       ...
       <section className="flex flex-col px-4 justify-center mb-10">
        <h1 className="text-prpl font-semibold mt-27 text-center">Симуляционно-тренинговый центр</h1>
            <div className="flex flex-col sm:flex-row mt-8">
                ...
                <h2 className="text-xl text-green p-2 mt-2 text-center">{activeItem?.title}</h2>
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            <h2 className="text-prpl py-2">В СТЦ Академии воспроизведен кабинет манипуляционная, оснащенный следующим оборудованием</h2>
                ...
                ]} cols="lg:grid-cols-5 sm:grid-cols-1 tablet:grid-cols-2"/>
        </div>
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            <MediaGallery
            cols="lg:grid-cols-4 sm:grid-cols-1 tablet:grid-cols-2"
            items={[
                ...
                { type: "video", src: "https://rutube.ru/play/embed/75a6452524e2ed9ac387a654c208b57e", preview: "/video-preview1.jpg" },            
                { type: "video", src: "https://rutube.ru/play/embed/35c0a78073eac3c019deec0d4469d2d7", preview: "/video-preview1.jpg" },
            ]}
            />
         ...
         <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            ...
            <p className="!font-normal">В СТЦ Академии работает симуляционная родовая, в которой проходят обучение как врачи акушеры-гинекологи, так и акушерки.
                ...
                <ImageGallery cols=" sm:grid-cols-1 tablet:grid-cols-2 lg:grid-cols-4" items={[ { type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/3.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/4.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/5.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/6.png" },]} />
        </div>

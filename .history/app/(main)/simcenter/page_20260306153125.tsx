       ...
       <section className="flex flex-col px-4 justify-center mb-10">
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            <h2 className="text-prpl py-2">В СТЦ Академии воспроизведен кабинет манипуляционная, оснащенный следующим оборудованием</h2>
                ...
                ]} cols="grid-cols-5 sm:grid-cols-1 tablet:grid-cols-2"/>
        </div>
        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
            ...
            <MediaGallery
            cols="grid-cols-4 sm:grid-cols-1 tablet:grid-cols-2"
            items={[
         ...
         <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            ...
            <p className="!font-normal">В СТЦ Академии работает симуляционная родовая, в которой проходят обучение как врачи акушеры-гинекологи, так и акушерки.
                ...
                <ImageGallery cols="grid-cols-4 sm:grid-cols-1 tablet:grid-cols-2" items={[ { type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/3.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/4.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/5.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/6.png" },]} />
        </div>

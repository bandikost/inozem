        ...
        <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-8 ">
         ...
         <div className="border border-gray-300 rounded shadow-2xl bg-white px-6 py-4 mt-12">
            ...
            <p className="!font-normal">В СТЦ Академии работает симуляционная родовая, в которой проходят обучение как врачи акушеры-гинекологи, так и акушерки.
                ...
                <ImageGallery cols="grid items-center justify-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4" items={[ { type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/3.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/4.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/5.png" },{ type: "image", src: "https://storage.yandexcloud.net/inozemstorage/simcenter/6.png" },]} />
        </div>

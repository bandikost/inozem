    ...
    <div className="max-w-[400px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-4 mb-6 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <div className="relative">
          ...
          <button type="button" onClick={() => setShowPassword((prev) => !prev)} className="absolute right-2 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-900 cursor-pointer">
            {showPassword ? "🙈" : "👁️"}
          </button>
        </div>

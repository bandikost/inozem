    ...
    <div className="max-w-[400px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-4 mb-6 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <div className="relative">
          <input className="border border-zinc-400 p-1.5 rounded text-zinc-700 w-full" name="password" type={showPassword ? "text" : "password"} placeholder="Пароль" value={form.password} onChange={handleChange} required/>

  ...
  return (
    <div className="max-w-[400px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-10 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <p className="ml-4 mt-4 text-zinc-700">У вас еще нет аккаунта? <Link className="text-blue-500 hover:underline" href={"/register"}>Регистрация</Link></p>
        <p className="ml-4 mt-1 text-zinc-700">У вас еще нет аккаунта? <Link className="text-blue-500 hover:underline" href={"/register"}>Регистрация</Link></p>

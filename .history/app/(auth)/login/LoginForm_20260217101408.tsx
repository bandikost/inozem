...
export default function LoginForm() {
  ...
  return (
    <div className="max-w-[400px] mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 mt-10 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        <input
      ...
      <p className="ml-4 mt-4 text-zinc-700">У вас еще нет личного аккаунта? <Link className="text-blue-500 hover:text-blue-700" href={"/login"}>Регистрация</Link></p>

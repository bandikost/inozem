...
export default function LoginForm() {
  ...
  return (
    <div className="max-w-[400px] mx-auto">
        ...
        <p className="text-center mt-4 text-zinc-700 !font-normal !text-lg">У вас еще нет аккаунта? <Link className="text-blue-500 hover:underline" href={"/register"}>Регистрация</Link></p>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-4 mb-4 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <Link className="text-blue-500 hover:underline ml-4 mt-8" href={"/register"}>Забыли пароль?</Link>
        <p className="fixed -top-100 left-10">Вернуться на <Link className="text-blue-500 hover:text-blue-700" href={"/"}>главную</Link> </p>

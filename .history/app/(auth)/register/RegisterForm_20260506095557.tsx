  ...
  return (
    <div className="max-w-[400px] mx-auto h-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-5 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <input className="border border-zinc-400 p-1.5 rounded text-lg text-zinc-700 !font-normal" name="patronymic" placeholder="Отчество" value={form.patronymic} onChange={handleChange} required maxLength={30} />

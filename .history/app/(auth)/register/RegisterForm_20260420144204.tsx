  ...
  return (
    <div className="max-w-[400px] mx-auto h-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-5 border border-zinc-400 rounded-xl p-4 shadow-2xl">
        ...
        <input className="border border-zinc-400 p-1.5 rounded text-zinc-700 !font-normal" name="last_name" placeholder="Фамилия" value={form.last_name} onChange={handleChange} required maxLength={30} />
        <input className="border border-zinc-400 p-1.5 rounded text-zinc-700 !font-normal" name="patronymic" placeholder="Отчество" value={form.patronymic} onChange={handleChange} maxLength={30} />
        <input className="border border-zinc-400 p-1.5 rounded text-zinc-700 !font-normal" name="email" type="email" placeholder="Почта" value={form.email} onChange={handleChange} required maxLength={40} />

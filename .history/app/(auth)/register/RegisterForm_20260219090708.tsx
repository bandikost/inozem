  ...
  >
    {showPassword ? <EyeOff className="cursor-pointer hover:text-zinc-900" size={18} /> : <Eye className="cursor-pointer hover:text-zinc-900"  size={18} />}
        ...
        <div className="flex items-center">
          ...
          <p className="text-sm text-zinc-700 ">Согласие на <Link target="_blank" href={"/files/personalize/personal-data.pdf"} className="text-blue hover:text-blue-700">обработку персональных данных</Link></p>
        </div>        

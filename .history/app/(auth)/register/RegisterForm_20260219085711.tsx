  ...
  >
    {showPassword ? <EyeOff className="cursor-pointer hover:text-zinc-900" size={18} /> : <Eye className="cursor-pointer hover:text-zinc-900"  size={18} />}
        ...
        <div className="flex items-center">
          <input type="checkbox" className="cursor-pointer" checked={confirm} onChange={(e) => setConfirm(e.target.confirm) } />
          <p className="text-sm text-zinc-700 ml-2">Согласие на <Link href="" className="text-blue hover:text-blue-700">обработку персональных данных</Link></p>
        </div>        
        

        <button type="submit"  disabled={loading && !confirm} className="flex items-center px-4 py-2 bg-purple-600 text-white text-center rounded flex cursor-pointer hover:bg-prpl disabled:opacity-50 disabled:cursor-not-allowed">

...
export default async function NewsListPage() {
  ...
  return (
    <section className='flex flex-col justify-center items-center border-2 border-dotted border-zinc-300 pb-8 mt-8 rounded shadow-2xl bg-white'>
      <h1 className='text-2xl font-normal mt-10'>Новости</h1>

...
const USER_HASH = process.env.PRUFFME_USER_HASH
const SECRET_HASH = process.env.PRUFFME_SECRET_HASH

if (!USER_HASH || !SECRET_HASH) {
    throw new Error("PRUFFME_USER_HASH или PRUFFME_SECRET_HASH не заданы")
}
